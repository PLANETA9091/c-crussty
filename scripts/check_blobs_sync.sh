...
check_class \
  ...
  "cmp421_brain" "cmp422_brain2" "cmp430_inside" "goal-selector EFFECT armed" "goalCleanup" "goalUpdate" \
...
check_class \
  ...
  "cmp420_chunk2" "cmp420_colpush" "cmp434_chunkpl" "cmp435_chunk3" "parse-cache first hit" "parse-cache selftest" \
