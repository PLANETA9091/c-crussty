...
check_class \
  ...
  "items_restplane ARMED" "cmp417_bq" "cmp414_cvs" "cmp412_meganav" "cmp412_eqsnapv3" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" \
...
check_class \
  ...
  "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" "goal-selector EFFECT armed" "goalCleanup" "goalUpdate" \
...
check_class \
  ...
  "cmp417_bq" "cmp420_colpush" "cmp412_b2p1" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" "selfTest" "isHardCollidingProbe"

check_class \
  "mobai/build/net/minecraft/world/entity/MobAiOps.class" \
  "cmp417_bq" "cmp420_colpush" "cmp414_cvs" "cmp412_meganav" "cmp412_eqsnapv3" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" \
  "native"
...
check_class \
  ...
  "cmp438_sense" "cmp430_inside" "cmp451_senseins" "cmp455_spawn" "nearestEntityGate" "sense EFFECT" "selfTest" \
  "native int senseProbe" "native int senseEpoch"

check_class \
  "randomtick/build/net/minecraft/world/entity/ai/BrainOps.class" \
  "cmp438_sense" "cmp439_sense_scan" "cmp451_senseins" "cmp455_spawn" "selfTestTickEach" "tickEachRunning" \
  "sense tick2 EFFECT armed"

check_class \
  "mobpush/build/net/minecraft/world/entity/MobPushOps.class" \
  "cmp417_bq" "cmp414_cvs" "cmp412_meganav" "cmp412_eqsnapv3" "cmp420_colpush" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" \
  "native int mobProbe" "boxFor" "colpushSweep"

check_class \
  "colpush/build/net/minecraft/world/entity/ColpushOps.class" \
  "cmp420_colpush" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" "pushEntities" "bulkTick" "selfTest" "armed" \
...
check_class \
  ...
  "cmp414_cvs" "cmp412_eqsnapv3" "cmp420_colpush" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp455_spawn" \
