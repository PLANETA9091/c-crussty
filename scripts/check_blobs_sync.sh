...
check_class \
  ...
  "items_restplane ARMED" "cmp417_bq" "cmp414_cvs" "cmp412_meganav" "cmp412_eqsnapv3" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" \
...
check_class \
  ...
  "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" "goal-selector EFFECT armed" "goalCleanup" "goalUpdate" \
...
check_class \
  ...
  "cmp417_bq" "cmp420_colpush" "cmp412_b2p1" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" "selfTest" "isHardCollidingProbe"

check_class \
  "mobai/build/net/minecraft/world/entity/MobAiOps.class" \
  "cmp417_bq" "cmp420_colpush" "cmp414_cvs" "cmp412_meganav" "cmp412_eqsnapv3" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" \
  "native"
...
check_class \
  ...
  "cmp438_sense" "cmp430_inside" "cmp451_senseins" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" "nearestEntityGate" "sense EFFECT" "selfTest" \
...
check_class \
  ...
  "cmp417_bq" "cmp414_cvs" "cmp412_meganav" "cmp412_eqsnapv3" "cmp420_colpush" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" \
  "native int mobProbe" "boxFor" "colpushSweep"

check_class \
  "colpush/build/net/minecraft/world/entity/ColpushOps.class" \
  "cmp420_colpush" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" "pushEntities" "bulkTick" "selfTest" "armed" \
...
check_class \
  ...
  "cmp414_cvs" "cmp412_eqsnapv3" "cmp420_colpush" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp432_inside2" "cmp451_senseins" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp444_chunk5" "cmp450_chunk" "cmp452_mega" "cmp453_diet" "cmp456_chunkmono" \
...
check_class \
  ...
  "cmp420_chunk2" "cmp420_colpush" "cmp434_chunkpl" "cmp435_chunk3" "cmp437_chunk4" "cmp453_diet" "cmp456_chunkmono" "parse-cache first hit" "parse-cache selftest" \
...
check_class \
  ...
  "cmp437_chunk4" "cmp435_chunk3" "cmp444_chunk5" "cmp450_chunk" "cmp453_diet" "cmp456_chunkmono" "chunk4 send-snapshot first hit" "chunk4 snapshot selftest PASS" "chunk4 stats" \
...
check_class \
  ...
  "cmp444_chunk5" "cmp450_chunk" "cmp437_chunk4" "cmp435_chunk3" "cmp456_chunkmono" "chunk5 payload-cache first hit" "chunk5 payload selftest PASS" "chunk5 stats" \
  "public static void write" "public static boolean selfTest"

# TASK-456-C chunk6-sched scheduling mono-plane (cmp456_chunkmono): the
# bridge must declare the two retarget statics (getNow/onSetFullChunk,
# receiver-prepended) + the native table (mirrorEvent/schedProbe) + the
# effect markers; the lever gate lives rust-side (chunk_sched.rs STRICT-OR
# carrier list) — this blob carries no lever id, like the inside-plane
# subsystem bridges (TASK-430-B precedent).
check_class \
  "chunksched/build/net/minecraft/server/level/ChunkSchedOps.class" \
  "public static net.minecraft.world.level.chunk.LevelChunk getNow" "public static void onSetFullChunk" "vanillaNow" "public static boolean selfTest" "public static void arm" \
  "native boolean mirrorEvent" "native long schedProbe" "EFFECT armed" "fail-open"
