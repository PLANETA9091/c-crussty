...
check_class \
  ...
  "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp437_chunk4" "goal-selector EFFECT armed" "goalCleanup" "goalUpdate" "cmp432_inside2" "cmp440_ins4d" \
...
check_class \
  ...
  "cmp417_bq" "cmp420_colpush" "cmp412_b2p1" "cmp421_brain" "cmp422_brain2" "cmp430_inside" "cmp437_chunk4" "selfTest" "isHardCollidingProbe" "cmp432_inside2" "cmp440_ins4d"
