#!/usr/bin/env bash
# merge_safety_gate.sh — x466 14f/C77: единый 4-ценз-гейт + обёртка merge-скриптов.
#
...
#
# Usage:
#   scripts/merge_safety_gate.sh --check-only              # только 4 гейта
