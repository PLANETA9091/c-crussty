#!/usr/bin/env python3
"""dispatch_round406_e.py — TASK-406-E: нога eleg1 (cmp406_sscan @
round-406-e-sscan 63bf3b3, R4 despawn-scan батч: один bulk-JNI/тик
Mob.checkDespawn → Level.findNearbyPlayer сайт → MobScanOps gate → колонка
ближайшего qualifying-игрока из SoA-позиций). inputs = банк РОВНО."""
...
LEGS = {
    "eleg1": ("round-406-e-l1", "cmp406_sscan", "origin/round-406-e-sscan"),
}
