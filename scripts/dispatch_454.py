#!/usr/bin/env python3
"""dispatch_454.py — TASK-454 (tick-454, 12:08 +08 2026-09-25) — ВАНИЛЬ-ВЕРИФИКАЦИЯ 05c6da1b + ПУЛ ПАР.
Якорная решётка ×12 (пустой lever на master f673819d/05c6da1b после senseins-мерджа).
...
BATCH = [
    ("anchor-1",  "round-454-anchor-1",  "master", ""),
    ("anchor-2",  "round-454-anchor-2",  "master", ""),
    ("anchor-3",  "round-454-anchor-3",  "master", ""),
    ("anchor-4",  "round-454-anchor-4",  "master", ""),
    ("anchor-5",  "round-454-anchor-5",  "master", ""),
    ("anchor-6",  "round-454-anchor-6",  "master", ""),
    ("anchor-7",  "round-454-anchor-7",  "master", ""),
    ("anchor-8",  "round-454-anchor-8",  "master", ""),
    ("anchor-9",  "round-454-anchor-9",  "master", ""),
    ("anchor-10", "round-454-anchor-10", "master", ""),
    ("anchor-11", "round-454-anchor-11", "master", ""),
    ("anchor-12", "round-454-anchor-12", "master", ""),
]

EXPECTED_SHA = {
    "master": "05c6da1b",  # senseins-серт мердж (ancestry-семантика; docs поверх кода)
    # TASK-454-B: chunk rebaze-2 union (merдж ccfa6f04 ⊕ b83c19e0); ancestry-семантика — код-носитель ded8f650, docs-коммиты поверх разрешены
    "round-454b-chunk": "ded8f650",
}

ANCESTRY_BASES = {"master", "round-454b-chunk"}
...
def main():
    ...
    if "--help" in args or "-h" in args:
        print("usage: dispatch_454.py [--dry-run] [--no-batch] [--leg name:branch:base:lever ...]")
    ...
    print("=== TICK-454 VANILLA-VERIFY LATTICE ===", flush=True)
    ...
    for leg, branch, base, lever in batch:
        ...
        time.sleep(4)
    print(f"=== TICK-454 BATCH COMPLETE: {len(batch)} диспатчей ===", flush=True)
