#!/usr/bin/env python3
"""dispatch_round406_d.py — TASK-406-D: нога композиции stagtick⊕ai-window
(cmp406_aibatch @ round-406-d-aibatch). Alias-ref для per-ref параллели."""
...
LEGS = {
    "dleg3": ("round-406-d-l3", "cmp406_aibatch", "origin/round-406-d-aibatch"),
}
