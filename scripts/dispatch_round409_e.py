#!/usr/bin/env python3
"""dispatch_round409_e.py — TASK-409-E: ноги eleg2/eleg3 (cmp406_sscan @
round-406-e-sscan fb8dc77, R4 despawn-scan батч min-of-3 закрытие серии
eleg1 2.55@6905070 +15.9pp). inputs = банк РОВНО (identical eleg1)."""
