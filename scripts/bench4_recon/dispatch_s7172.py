#!/usr/bin/env python3
"""dispatch_s7172.py — re-dispatch of the ZERO-CURSOR lever #11 v1 gate leg (TASK-331): s7171 ran DORMANT — resolution closure demanded reset(...)Ljava/util/Iterator; while the bridge declares reset(...)V, PG-Z2 FAIL, lever never measured; fixed cd4baab (+closure-pin unit test), same inputs, same gates
...
PREREGISTER GATES (absorb; A/B vs fresh same-bank profile s7169 = 35437243128; s7170 35440054574 = shell defect; s7171 35441020234 = closure defect, dormant
and banked v3 legs):
