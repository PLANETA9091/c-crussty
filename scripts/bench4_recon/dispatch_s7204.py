#!/usr/bin/env python3
"""dispatch_s7204.py - активационный лег #15 INSIDE-BITMASK на БАНКЕ v4 (s7204)
(TASK-385, директива владельца 20:08 «автономные A/B — без санкций, без
ожиданий»; преемник dispatch_s7195.py, устаревшего по банку v3/G1/якорю 1.60).
