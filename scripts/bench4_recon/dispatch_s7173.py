#!/usr/bin/env python3
"""dispatch_s7173.py — re-dispatch of the ZERO-CURSOR lever #11 v1 gate leg (TASK-331): s7172 verified but the served BlockPos bytes FAILED JVM VERIFICATION at retransform (JVMTI 62): static load chain was 1-based (receiver-convention) — fixed 4ddb10f (0-based slots, local retransform probe RETRANSFORM OK + SEMANTIC OK), same inputs, same gates
...
PREREGISTER GATES (absorb; A/B vs fresh same-bank profile s7169 = 35437243128; s7170 35440054574 = shell defect; s7171 35441020234 = closure defect; s7172 35442145580 = VerifyError at retransform
and banked v3 legs):
