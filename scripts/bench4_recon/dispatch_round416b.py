#!/usr/bin/env python3
"""dispatch_round416b.py — TASK-416-B iter-3: gsel-batch ноги ×3
...
Refs = alias-ветки round-416-b-g3a/g3b/g3c -> HEAD моей ветки (git refs API).
"""
...
LEGS = {
    "g3a": ("round-416-b-g3a", "cmp416_gsel3"),
    "g3b": ("round-416-b-g3b", "cmp416_gsel3"),
    "g3c": ("round-416-b-g3c", "cmp416_gsel3"),
}
