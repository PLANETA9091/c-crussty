#!/usr/bin/env python3
"""dispatch_s7200.py - GC-TUNE v2 leg s7200 (TASK-376, owner sanction 2026-09-20
...
batch_collector=1 + fluid_guard=1) + gc_tune=2, region_steal=0, travel_diet=0,
...
PREREGISTER GATES (absorb_s7200.py):
  PG-T1 delivery: gc_tune=2 + банк v3 rest + NCDFE=0 + pop 150k VALID +
