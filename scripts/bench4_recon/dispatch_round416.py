#!/usr/bin/env python3
"""dispatch_round416.py — TASK-416: якоря ×3 fresh @master(5869010).
Якоря = vanilla (lever_flag=""), band 6.0-9.5M, банк inputs exact.
Usage: python3 dispatch_round416.py anchora,anchorb,anchorc
"""
...
LEGS = {
    "anchora": ("round-416-anchora", ""),
    "anchorb": ("round-416-anchorb", ""),
    "anchorc": ("round-416-anchorc", ""),
}
