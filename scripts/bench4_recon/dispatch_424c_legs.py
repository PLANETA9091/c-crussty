#!/usr/bin/env python3
"""dispatch_424c_legs.py — TASK-425-C: 3 legs l1/l2/l3 @round-424-c-chunk,
lever_flag=cmp424_chunksend, inputs РОВНО банк (world-bench-parallel.yml)."""
...
LEGS = {
    "l1": ("round-424-c-l1", "cmp424_chunksend", "round-424-c-chunk"),
    "l2": ("round-424-c-l2", "cmp424_chunksend", "round-424-c-chunk"),
    "l3": ("round-424-c-l3", "cmp424_chunksend", "round-424-c-chunk"),
}
...
def local_sha(branch):
    return subprocess.run(["git", "-C", "/home/z/rounds/ROUND-423/agent-c/wt",
                           "rev-parse", branch],
                          capture_output=True, text=True).stdout.strip()
