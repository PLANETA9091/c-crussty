#!/usr/bin/env python3
"""dispatch_round416b_iter4.py — TASK-416-B iter-4: gsel fastpath ноги ×3
@round-416-b-gsel3 head (ЖИВОЙ cvs-носитель 1aec4f8 + gsel-слайс, cmp416_gsel3).
Банк inputs exact; lever_arg=1; НЕТ travel_diet/fluid_dirty_ledger.
Refs = alias-ветки round-416-b-g4a/g4b/g4c -> HEAD моей ветки (git refs API).
"""
...
LEGS = {
    "g4a": ("round-416-b-g4a", "cmp416_gsel3"),
    "g4b": ("round-416-b-g4b", "cmp416_gsel3"),
    "g4c": ("round-416-b-g4c", "cmp416_gsel3"),
}
...
def main():
    ...
    head = subprocess.run(["git", "-C", "/home/z/rounds/ROUND-416/agent-b",
                            "rev-parse", "round-416-b-gsel3"],
                           capture_output=True, text=True).stdout.strip()
    print(f"head = {head[:7]}")
