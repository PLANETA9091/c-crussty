#!/usr/bin/env python3
"""dispatch_round405.py — TASK-405: 2 якорных ноги (master 6a0879f, банк v4, lever="")
+ 1 stagcomp день-4 дрейф-лег (cmp402_stagcomp @ round-402-f-stagcomp 60fe902).
Alias-refs для per-ref параллели. Структура = dispatch_round403.py без изменений.
"""
