#!/usr/bin/env python3
"""dispatch_round413c.py — TASK-413-C: eqsnap-v3 NCDFE-fix legs ×2
(= eqsnap-v3 повторно: EARLY define EntityGoalQueryOps + mobs_manager HARD
publish gate, ветка round-413-c-v3b = alias на round-412-c-v3 @ 43a8318,
флаг cmp412_eqsnapv3, inputs банковские РОВНО).
Alias-refs round-413-cv3b-{1,2} для per-ref параллели (sha резолвится через
...
LEGS = {
    "cv3b1": ("round-413-cv3b-1", "round-413-c-v3b", "cmp412_eqsnapv3"),
    "cv3b2": ("round-413-cv3b-2", "round-413-c-v3b", "cmp412_eqsnapv3"),
}
