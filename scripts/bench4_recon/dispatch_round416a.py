#!/usr/bin/env python3
"""dispatch_round416a.py — TASK-416-A: ноги mc2a/mc2b/mc2c @round-416-a-mc2 head
(iter-2 gate-reconciliation, lever cmp416_mcomp), банк inputs exact.
Usage: python3 dispatch_round416a.py mc2a,mc2b,mc2c
"""
...
LEGS = {
    "mc2a": ("round-416-a-mc2a", "cmp416_mcomp"),
    "mc2b": ("round-416-a-mc2b", "cmp416_mcomp"),
    "mc2c": ("round-416-a-mc2c", "cmp416_mcomp"),
}
...
def main():
    ...
    head = subprocess.run(["git", "-C", "/home/z/rounds/ROUND-416/agent-a", "rev-parse", "HEAD"],
                          capture_output=True, text=True).stdout.strip()
