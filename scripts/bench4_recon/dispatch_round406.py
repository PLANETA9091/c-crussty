#!/usr/bin/env python3
"""dispatch_round406.py — TASK-406: 2 свежих якорных ноги (master, lever_flag="")
для pair-вердиктов волны-406 (R-векторы закона 6). Alias-refs per-ref."""
...
LEGS = {
    "anchora": ("round-406-anchora", "", "origin/master"),
    "anchorb": ("round-406-anchorb", "", "origin/master"),
}
