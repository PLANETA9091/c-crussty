#!/usr/bin/env python3
"""dispatch_s7201.py - GC COLLECTOR SWAP leg s7201 (TASK-381, owner sanction 2026-09-20
...
batch_collector=1 + fluid_guard=1) + gc_tune=3, region_steal=0, travel_diet=0,
...
PREREGISTER GATES (absorb_s7201.py):
  PG-T1 delivery: gc_tune=3 + банк v3 rest + NCDFE=0 + pop 150k VALID +
