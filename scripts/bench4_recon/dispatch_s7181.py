#!/usr/bin/env python3
"""dispatch_s7181.py - STEAL v2 CONFIRMING leg (min-of-2) vs s7178 anchor (TASK-340).

Dispatched ONLY after absorb_s7180 delivers CANDIDATE GREEN (paired delta
>= +10% vs anchor 1.40 @ 8493973). Banking rule (paired min-of-2, RECON-19):
BOTH lever legs (s7180 + s7181) >= +10% normalized -> CUMULATIVE v4 =
v3 + region_steal=1 + bu_defer=1. Otherwise lane stays open -> RECON-20
lever #14 TRAVEL-ALLOC-DIET (fresh TOP-1 CPU = GC/JVM 36.2% = alloc churn,
recon20_top_s7178.py).
...
s7181 = region_steal=1 + bu_defer=1 (STEAL v2 / BU-DEFER infrastructure,
