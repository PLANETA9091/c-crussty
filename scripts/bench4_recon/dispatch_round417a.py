#!/usr/bin/env python3
"""dispatch_round417a.py — TASK-417-A: ноги mc3a/mc3b/mc3c @round-417-a-mconv head
(iter-3 protocol v2 + queryplane find_class fix, lever cmp417_mcomp), банк inputs exact.
Usage: python3 dispatch_round417a.py mc3a,mc3b,mc3c
"""
...
LEGS = {
    "mc3a": ("round-417-a-mc3a", "cmp417_mcomp"),
    "mc3b": ("round-417-a-mc3b", "cmp417_mcomp"),
    "mc3c": ("round-417-a-mc3c", "cmp417_mcomp"),
}
...
def main():
    ...
    head = subprocess.run(["git", "-C", "/home/z/rounds/ROUND-417/agent-a", "rev-parse", "HEAD"],
                          capture_output=True, text=True).stdout.strip()
    print(f"agent-a head = {head[:7]}")
