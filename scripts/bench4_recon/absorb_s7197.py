...
RUN_DIR = os.path.join(RESDIR, "run-s7197-mainoffload-v1")
...
def main():
    ...
    rep = [f"# absorb S7-172 P2-OFFLOAD v1 s7197 (run {run_id}, head "
    ...
    if stdout_txt:
        # ---- PG-T1 delivery (S7-172 MAIN-OFFLOAD armed + bank v3 rest)
        want = {"region_steal": "2", "travel_diet": "0", "zero_alloc": "0",
