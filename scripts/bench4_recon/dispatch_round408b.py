#!/usr/bin/env python3
"""dispatch_round408b.py — TASK-409: 2 ноги мультикомпозита cmp409_multi
@ round-408-f-multi f7d04d2 (comp⊕aibatch⊕sscan)."""
...
LEGS = {
    "multi1": ("round-408-multi1", "cmp409_multi", "origin/round-408-f-multi"),
    "multi2": ("round-408-multi2", "cmp409_multi", "origin/round-408-f-multi"),
}
