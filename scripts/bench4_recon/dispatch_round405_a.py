#!/usr/bin/env python3
"""dispatch_round405_a.py — TASK-405-A restart: nav-plane bulk нога
(cmp405_navplane @ round-405-a-nav 1aba03e). Alias-ref для per-ref параллели."""
...
LEGS = {
    "aleg1": ("round-405-a-l1", "cmp405_navplane", "origin/round-405-a-nav"),
}
