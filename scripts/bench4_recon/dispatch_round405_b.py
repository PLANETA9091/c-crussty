#!/usr/bin/env python3
"""dispatch_round405_b.py — TASK-405-B restart: fluid→Rust bulk push plane
(cmp405_fluidplane @ origin/round-405-b-fluid eb7a870). Alias-refs для
per-ref параллели. Банк inputs = РОВНО банк раунда (как dispatch_round405_comp).
"""
...
LEGS = {
    "bleg1": ("round-405-b-l1", "cmp405_fluidplane", "origin/round-405-b-fluid"),
}
