#!/usr/bin/env python3
"""dispatch_round403.py — TASK-403: 3 якорных ноги (банк v4, lever_flag="")
+ 2 legs stagcomp ре-рана (cmp402_stagcomp @ round-402-f-stagcomp 60fe902).
Alias-refs создаются по需要 для per-ref параллели.
"""
...
LEGS = {
    "anchor1": ("master",            "",                None),
    "anchor2": ("round-403-anchor2", "",                "origin/master"),
    "anchor3": ("round-403-anchor3", "",                "origin/master"),
    "stcomp1": ("round-403-stcomp1", "cmp402_stagcomp", "origin/round-402-f-stagcomp"),
    "stcomp2": ("round-403-stcomp2", "cmp402_stagcomp", "origin/round-402-f-stagcomp"),
}
