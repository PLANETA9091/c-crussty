#!/usr/bin/env python3
"""dispatch_round412c.py — TASK-412-C (v16): leg cr1 = alias round-412-c-r1
→ HEAD ветки round-412-c-r1 (K4-v2 cmp411_eqsnap @24008bd).
Банковские inputs ровно как в dispatch_round412.py; lever=cmp411_eqsnap."""
...
LEGS = {
    "cr1": ("round-412-c-r1", "round-412-c-r1", "cmp411_eqsnap"),
}
...
def main():
    ...
    refs = {
        "round-412-c-r1": subprocess.run(
            ["git", "-C", "/home/z/rounds/ROUND-412/agent-c", "rev-parse", "HEAD"],
            capture_output=True, text=True).stdout.strip(),
    }
