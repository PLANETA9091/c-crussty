#!/usr/bin/env python3
"""dispatch_round405_c.py — TASK-405-C (vector eindex): Rust chunk-entity mirror
(cmp405_eindex @ round-405-c-eindex) vs пул якорей round-405."""
...
LEGS = {
    "cleg2": ("round-405-c-l2", "cmp405_eindex", "origin/round-405-c-eindex"),
}
