#!/usr/bin/env python3
"""dispatch_s7198.py - S7-174 P2-OFFLOAD v2 PUMP leg (TASK-373), RECON-37 fork:
...
LEVER (S7-174 v2): CRUSSTY_REGION_STEAL="3" = MAIN-OFFLOAD + main pumps moonrise$midTickTasks during phase-3 (pump-restoration = root-cause fix of v1 -19..-21% regression: s7197 recon showed pump serialization, ~+30% bucket-samples/tick) —
...
region_threads=4, batch_collector=1, travel_diet=0, region_steal=3(!),
bu_defer=0.
...
ABSORB: adapt absorb_s7196.py -> absorb_s7198.py (expect region_steal: 2 in
