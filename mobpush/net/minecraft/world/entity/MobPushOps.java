...
public final class MobPushOps {
    ...
    private static boolean leverEnabled() {
        ...
        return f != null
                && (f.trim().equals("cmp401_soa") || f.trim().equals("cmp402_comp")
                    ...
                    || f.trim().equals("cmp428_chunkunion") || f.trim().equals("cmp429_wgen"));
    }
    ...
    private static String eqsnapFlagLabel() {
        ...
        if (f != null && (f.trim().equals("cmp428_chunkunion") || f.trim().equals("cmp429_wgen"))) return "cmp424_mobfeed"; // TASK-428-C/429-A carrier label
