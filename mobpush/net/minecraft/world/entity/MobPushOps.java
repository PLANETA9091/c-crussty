...
public final class MobPushOps {
    ...
    private static String eqsnapFlagLabel() {
        ...
        if (f != null && f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp428_chunkunion") || f.trim().equals("cmp429_wgen") || f.trim().equals("cmp434_wgen3")) return "cmp424_mobfeed"; // TASK-426-A
