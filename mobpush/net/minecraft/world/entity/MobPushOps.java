...
public final class MobPushOps {
    ...
    private static boolean leverEnabled() {
        ...
        return f != null
                && (f.trim().equals("cmp401_soa") || f.trim().equals("cmp402_comp")
                    ...
                    || f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp430_inside") || f.trim().equals("cmp432_inside2") || f.trim().equals("cmp436_ins4") || f.trim().equals("cmp451_senseins") || f.trim().equals("cmp457_eqsnap2") || f.trim().equals("cmp452_mega") || f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp430_inside") || f.trim().equals("cmp434_chunkpl") || f.trim().equals("cmp435_chunk3") || f.trim().equals("cmp437_chunk4") || f.trim().equals("cmp444_chunk5") || f.trim().equals("cmp450_chunk") || f.trim().equals("cmp452_mega") || f.trim().equals("cmp453_diet"));
    }
    ...
    private static String eqsnapFlagLabel() {
        ...
        if (f != null && f.trim().equals("cmp436_ins4") || f.trim().equals("cmp457_eqsnap2")) return "cmp436_ins4"; // TASK-436-B
