 ...
 * RNG: пропущенный полл не потребляет nextInt — расходится статистически.
 * Окно N: env CRUSSTY_STAGGER_N → CRUSSTY_LEVER_ARG → дефолт 4
 * (legacy TASK-401; N-scan по флагам — TASK-403 на round-403-a-*).
 */
