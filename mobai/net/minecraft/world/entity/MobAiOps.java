...
public final class MobAiOps {
    ...
    private static boolean leverEnabled() {
        ...
        return f != null && (f.trim().equals("cmp406_aibatch")
                ...
                || f.trim().equals("cmp409_multi") || f.trim().equals("cmp412_meganav") || f.trim().equals("cmp412_b2p1") || f.trim().equals("cmp415_mcomp") || f.trim().equals("cmp416_mcomp") || f.trim().equals("cmp417_mcomp"));
    }
