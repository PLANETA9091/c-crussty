...
- boot reached Done: **1** (boot time 14.641 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [21.7, 1.8, 2.0, 2.3, 2.6, 2.5]
- spark tick-monitor MSPT: avg **399.5ms** / min 344.51ms / max **502.63ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-24T14:50:34Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 6826709 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 344.51 | — | — | — | 502.63 | 399.5 |

- entity totals seen: [149008, 150398, 151356]
- top entity types (max seen): minecraft:item×103348, minecraft:creeper×5240, minecraft:husk×5160, minecraft:skeleton×4831, minecraft:spider×4772, minecraft:zombie×4636, minecraft:drowned×4524, minecraft:sheep×3524, minecraft:chicken×3420, minecraft:cow×3392, minecraft:pig×3231, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/p6aOfzwPT6
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **121** (Full GC: **9**)
- total pause: **20608.8 ms**, avg **170.32 ms**, max **2389.5 ms**
- heap high-water seen: **7497 MB** -> last-after: **4227 MB**
...
### CPU profile — self-time by research bucket (total self-time samples: 116829)

| bucket | self-time samples | share |
|---|---|---|
| entities/mobs (kernel) | 29061 | 24.9% |
| kernel: other | 27678 | 23.7% |
| other | 15084 | 12.9% |
| moonrise/paper patches | 10066 | 8.6% |
| chunk system (kernel) | 9383 | 8.0% |
| fastutil collections | 6718 | 5.8% |
| JDK collections | 6182 | 5.3% |
| JIT stubs (vtable/itable) | 3540 | 3.0% |
| network (kernel) | 3401 | 2.9% |
| JDK invokes/VarHandle | 2583 | 2.2% |
| JDK other | 2070 | 1.8% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 92980 | 79.6% |
| phase: unclassified | 14032 | 12.0% |
| phase: main tick (unclassified) | 3788 | 3.2% |
| phase: chunk tick | 1926 | 1.6% |
| phase: network sync (ServerEntity) | 1800 | 1.5% |
| phase: chunk system (off-main worker) | 1090 | 0.9% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **100830** (86.3%) · native/JVM-internal **15892** (13.6%) · other **107** (0.1%)
...
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2671 | 2.3% |
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices$EntityCollectionBySection.getEntities` | JVM-Java | 2141 | 1.8% |
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1963 | 1.7% |
...
| `java/lang/invoke/VarHandleReferences$FieldInstanceReadOnly.getVolatile` | JVM-Java | 1542 | 1.3% |
| `net/minecraft/util/SimpleBitStorage.get` | JVM-Java | 1528 | 1.3% |
...
| `net/minecraft/server/level/ServerLevel$$Lambda.0x00007f10759e8d80.accept` | JVM-Java | 1298 | 1.1% |
| `ca/spottedleaf/concurrentutil/map/ConcurrentLong2ReferenceChainedHashTable.getNode` | JVM-Java | 1254 | 1.1% |
...
| `it/unimi/dsi/fastutil/objects/Reference2ObjectOpenHashMap.get` | JVM-Java | 1021 | 0.9% |
| `it/unimi/dsi/fastutil/longs/LongOpenHashSet.add` | JVM-Java | 984 | 0.8% |
| `net/minecraft/world/entity/Entity.getBoundingBox` | JVM-Java | 966 | 0.8% |
...
| `net/minecraft/server/level/ServerEntity.sendChanges` | JVM-Java | 759 | 0.6% |
...
| `itable stub` | native/JVM-internal | 620 | 0.5% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52440** (85.6%) · native/JVM-internal **8806** (14.4%) · other **7** (0.0%)
...
| `net/minecraft/server/level/ServerLevel$$Lambda.0x00007f10759e8d80.accept` | JVM-Java | 58 | 0.1% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 2007 | 55.2% |
| phase: unclassified | 1447 | 39.8% |
...
| `net.minecraft.world.phys.AABB_[i]` | other | 497 | 13.7% |
...
- **F1 module/JNI self-time share:** 0 / 116829 = **0.00%** — §8 PASS (< 2%)
- **F3 per-class entity tick split (top-12 by stack presence):**

| entity class tick | presence samples | share of CPU |
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34485 | 29.52% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22606 | 19.35% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6355 | 5.44% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5406 | 4.63% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4602 | 3.94% |
| `net/minecraft/world/entity/vehicle/AbstractBoat.tick` | 1159 | 0.99% |
| `net/minecraft/world/entity/ai/Brain.tick` | 916 | 0.78% |
...
| `net.minecraft.world.phys.AABB_[i]` | 497 | 13.7% |
| `char[]_[k]` | 440 | 12.1% |
| `byte[]_[k]` | 223 | 6.1% |
...
- **F2 GC-churn estimate:** 121 pauses / total 20609 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148110..151356 (delta 3246, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99726->103348, minecraft:drowned 3457->4524, minecraft:zombie 3627->4636, minecraft:husk 4489->5160, minecraft:creeper 4595->5240, minecraft:spider 4198->4772, minecraft:skeleton 4484->4831, minecraft:chicken 3389->3420
...
- `cpu-collapsed.txt` (56140639 B)
- `wall-collapsed.txt` (3770888 B)
- `alloc-collapsed.txt` (2015666 B)
- `cpu-flamegraph.html` (302540 B)
- `server-stdout.log` (250736 B)
- `gc.log` (114407 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
