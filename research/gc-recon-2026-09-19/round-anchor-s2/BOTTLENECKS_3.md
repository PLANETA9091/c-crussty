...
- boot reached Done: **1** (boot time 15.864 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [20.0, 1.7, 1.9, 2.2, 2.5, 2.5]
- spark tick-monitor MSPT: avg **409.35ms** / min 351.12ms / max **519.13ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-23T20:24:09Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 6726470 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 351.12 | — | — | — | 519.13 | 409.35 |

- entity totals seen: [149009, 150343, 151412]
- top entity types (max seen): minecraft:item×103375, minecraft:creeper×5285, minecraft:husk×5133, minecraft:skeleton×4815, minecraft:spider×4797, minecraft:zombie×4641, minecraft:drowned×4525, minecraft:sheep×3526, minecraft:chicken×3423, minecraft:cow×3389, minecraft:pig×3231, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/nqN96UbXIv
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **117** (Full GC: **9**)
- total pause: **20463.8 ms**, avg **174.90 ms**, max **2527.2 ms**
- heap high-water seen: **7548 MB** -> last-after: **4265 MB**
...
### CPU profile — self-time by research bucket (total self-time samples: 116316)

| bucket | self-time samples | share |
|---|---|---|
| entities/mobs (kernel) | 28882 | 24.8% |
| kernel: other | 28459 | 24.5% |
| other | 14162 | 12.2% |
| moonrise/paper patches | 9914 | 8.5% |
| chunk system (kernel) | 9545 | 8.2% |
| fastutil collections | 7077 | 6.1% |
| JDK collections | 6071 | 5.2% |
| JIT stubs (vtable/itable) | 3674 | 3.2% |
| network (kernel) | 3165 | 2.7% |
| JDK invokes/VarHandle | 2275 | 2.0% |
| JDK other | 2024 | 1.7% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 93172 | 80.1% |
| phase: unclassified | 13006 | 11.2% |
| phase: main tick (unclassified) | 3784 | 3.3% |
| phase: chunk tick | 2065 | 1.8% |
| phase: network sync (ServerEntity) | 1878 | 1.6% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **101103** (86.9%) · native/JVM-internal **15139** (13.0%) · other **74** (0.1%)
...
| `vtable stub` | native/JVM-internal | 3045 | 2.6% |
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2465 | 2.1% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1719 | 1.5% |
| `net/minecraft/network/syncher/SynchedEntityData$DataItem.getValue` | JVM-Java | 1700 | 1.5% |
| `ca/spottedleaf/moonrise/patches/collisions/CollisionUtil.getCollisionsForBlocksOrWorldBorder` | JVM-Java | 1633 | 1.4% |
| `PSCardTable::scavenge_contents_parallel` | native/JVM-internal | 1605 | 1.4% |
| `net/minecraft/util/Mth.floor` | JVM-Java | 1541 | 1.3% |
| `net/minecraft/util/SimpleBitStorage.get` | JVM-Java | 1531 | 1.3% |
| `java/util/HashMap.getNode` | JVM-Java | 1469 | 1.3% |
...
| `it/unimi/dsi/fastutil/objects/Reference2ObjectOpenHashMap.get` | JVM-Java | 1182 | 1.0% |
...
| `net/minecraft/world/entity/Entity.getBoundingBox` | JVM-Java | 911 | 0.8% |
...
| `net/minecraft/world/entity/RegionTickOps.bucketOf` | JVM-Java | 897 | 0.8% |
...
| `it/unimi/dsi/fastutil/objects/Object2ObjectOpenHashMap.get` | JVM-Java | 810 | 0.7% |
...
| `itable stub` | native/JVM-internal | 627 | 0.5% |
| `net/minecraft/server/level/ChunkMap$TrackedEntity.moonrise$tick` | JVM-Java | 622 | 0.5% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52407** (85.6%) · native/JVM-internal **8846** (14.4%) · other **4** (0.0%)
...
|---|---|---|
| phase: entity tick (AI/movement) | 2030 | 55.5% |
...
|---|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | other | 502 | 13.7% |
| `net.minecraft.world.phys.AABB_[i]` | other | 487 | 13.3% |
| `char[]_[k]` | other | 442 | 12.1% |
| `byte[]_[k]` | other | 213 | 5.8% |
...
| `net.minecraft.world.entity.Entity$$Lambda+0x00007fa6ba9d8000_[i]` | other | 39 | 1.1% |
...
- **F1 module/JNI self-time share:** 0 / 116316 = **0.00%** — §8 PASS (< 2%)
- **F3 per-class entity tick split (top-12 by stack presence):**

| entity class tick | presence samples | share of CPU |
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34480 | 29.64% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22837 | 19.63% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6545 | 5.63% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5388 | 4.63% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4528 | 3.89% |
...
|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | 502 | 13.7% |
| `net.minecraft.world.phys.AABB_[i]` | 487 | 13.3% |
| `char[]_[k]` | 442 | 12.1% |
| `byte[]_[k]` | 213 | 5.8% |
...
- **F2 GC-churn estimate:** 117 pauses / total 20464 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148117..151412 (delta 3295, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99718->103375, minecraft:drowned 3429->4525, minecraft:zombie 3701->4641, minecraft:creeper 4597->5285, minecraft:husk 4485->5133, minecraft:spider 4205->4797, minecraft:skeleton 4400->4815, minecraft:chicken 3393->3423
...
- `cpu-collapsed.txt` (58284139 B)
- `wall-collapsed.txt` (3754296 B)
- `alloc-collapsed.txt` (2083789 B)
- `cpu-flamegraph.html` (302345 B)
- `server-stdout.log` (252281 B)
- `gc.log` (110977 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
