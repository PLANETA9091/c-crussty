...
- boot reached Done: **1** (boot time 17.185 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [20.4, 1.6, 1.9, 2.0, 2.4, 2.5]
- spark tick-monitor MSPT: avg **429.77ms** / min 369.56ms / max **522.72ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-25T04:21:20Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 7163832 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 369.56 | — | — | — | 522.72 | 429.77 |

- entity totals seen: [149143, 150309, 151512]
- top entity types (max seen): minecraft:item×103396, minecraft:husk×5213, minecraft:creeper×5164, minecraft:skeleton×4869, minecraft:spider×4813, minecraft:zombie×4688, minecraft:drowned×4539, minecraft:sheep×3513, minecraft:chicken×3437, minecraft:cow×3384, minecraft:pig×3246, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/XV23DIXuqJ
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **114** (Full GC: **9**)
- total pause: **19904.8 ms**, avg **174.60 ms**, max **2418.1 ms**
- heap high-water seen: **7602 MB** -> last-after: **4340 MB**
...
|---|---|---|
| kernel: other | 28119 | 24.2% |
| entities/mobs (kernel) | 27617 | 23.8% |
| other | 15284 | 13.2% |
| moonrise/paper patches | 10194 | 8.8% |
| chunk system (kernel) | 9352 | 8.1% |
| fastutil collections | 7469 | 6.4% |
| JDK collections | 5894 | 5.1% |
| JIT stubs (vtable/itable) | 3553 | 3.1% |
| network (kernel) | 3057 | 2.6% |
| JDK invokes/VarHandle | 2620 | 2.3% |
| JDK other | 1868 | 1.6% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 91974 | 79.2% |
| phase: unclassified | 14132 | 12.2% |
| phase: main tick (unclassified) | 3770 | 3.2% |
| phase: chunk tick | 2078 | 1.8% |
| phase: network sync (ServerEntity) | 1781 | 1.5% |
| phase: chunk system (off-main worker) | 1111 | 1.0% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **99996** (86.1%) · native/JVM-internal **16017** (13.8%) · other **98** (0.1%)

### CPU profile — top-40 leaf frames by self-time

| leaf frame | kind | samples | share |
|---|---|---|---|
| `net/minecraft/world/level/chunk/PalettedContainer.get` | JVM-Java | 4364 | 3.8% |
| `net/minecraft/world/entity/Entity.updateFluidHeightAndDoFluidPushing` | JVM-Java | 3132 | 2.7% |
| `vtable stub` | native/JVM-internal | 2912 | 2.5% |
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2739 | 2.4% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1910 | 1.6% |
| `net/minecraft/network/syncher/SynchedEntityData$DataItem.getValue` | JVM-Java | 1796 | 1.5% |
| `net/minecraft/util/SimpleBitStorage.get` | JVM-Java | 1772 | 1.5% |
| `java/lang/invoke/VarHandleReferences$FieldInstanceReadOnly.getVolatile` | JVM-Java | 1656 | 1.4% |
...
| `java/util/HashMap.getNode` | JVM-Java | 1480 | 1.3% |
| `net/minecraft/util/Mth.floor` | JVM-Java | 1422 | 1.2% |
| `it/unimi/dsi/fastutil/objects/Reference2ObjectOpenHashMap.get` | JVM-Java | 1335 | 1.1% |
| `ca/spottedleaf/concurrentutil/map/ConcurrentLong2ReferenceChainedHashTable.getNode` | JVM-Java | 1303 | 1.1% |
| `net/minecraft/server/level/ServerLevel.lambda$tick$4` | JVM-Java | 1173 | 1.0% |
| `net/minecraft/network/syncher/SynchedEntityData.getItem` | JVM-Java | 1143 | 1.0% |
...
| `net/minecraft/world/level/chunk/LevelChunk.getBlockStateFinal` | JVM-Java | 899 | 0.8% |
...
| `itable stub` | native/JVM-internal | 636 | 0.5% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52384** (85.5%) · native/JVM-internal **8871** (14.5%) · other **4** (0.0%)
...
|---|---|---|
| phase: entity tick (AI/movement) | 2013 | 55.7% |
| phase: unclassified | 1419 | 39.3% |
| phase: main tick (unclassified) | 87 | 2.4% |
| phase: chunk system (off-main worker) | 67 | 1.9% |
...
|---|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | other | 534 | 14.8% |
| `net.minecraft.world.phys.AABB_[i]` | other | 510 | 14.1% |
| `char[]_[k]` | other | 435 | 12.0% |
| `byte[]_[k]` | other | 223 | 6.2% |
| `net.minecraft.core.BlockPos_[i]` | other | 184 | 5.1% |
...
| `net.minecraft.core.SectionPos_[i]` | other | 38 | 1.1% |
...
| `net.minecraft.world.entity.Entity$$Lambda+0x00007f23758fc498_[i]` | other | 33 | 0.9% |
...
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34013 | 29.29% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22564 | 19.43% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6471 | 5.57% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5276 | 4.54% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4653 | 4.01% |
...
|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | 534 | 14.8% |
| `net.minecraft.world.phys.AABB_[i]` | 510 | 14.1% |
| `char[]_[k]` | 435 | 12.0% |
| `byte[]_[k]` | 223 | 6.2% |
| `net.minecraft.core.BlockPos_[i]` | 184 | 5.1% |
...
- **F2 GC-churn estimate:** 114 pauses / total 19905 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148176..151512 (delta 3336, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99637->103396, minecraft:drowned 3448->4539, minecraft:zombie 3766->4688, minecraft:husk 4517->5213, minecraft:creeper 4514->5164, minecraft:spider 4239->4813, minecraft:skeleton 4350->4869, minecraft:chicken 3403->3437
...
- `cpu-collapsed.txt` (56313075 B)
- `wall-collapsed.txt` (3741340 B)
- `alloc-collapsed.txt` (2017664 B)
- `cpu-flamegraph.html` (300713 B)
- `server-stdout.log` (256004 B)
- `gc.log` (108392 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
