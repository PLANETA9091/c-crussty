...
- boot reached Done: **1** (boot time 17.5 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [19.2, 1.6, 1.9, 2.2, 2.6, 2.6]
- spark tick-monitor MSPT: avg **410.96ms** / min 346.87ms / max **587.61ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-23T19:17:16Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 6952698 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 346.87 | — | — | — | 587.61 | 410.96 |

- entity totals seen: [148899, 149981, 151213]
- top entity types (max seen): minecraft:item×103182, minecraft:husk×5189, minecraft:creeper×5180, minecraft:skeleton×4870, minecraft:spider×4796, minecraft:zombie×4644, minecraft:drowned×4573, minecraft:sheep×3534, minecraft:chicken×3392, minecraft:cow×3372, minecraft:pig×3220, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/zUPUWtTfd5
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **120** (Full GC: **9**)
- total pause: **20655.9 ms**, avg **172.13 ms**, max **2391.0 ms**
- heap high-water seen: **7464 MB** -> last-after: **4177 MB**
...
### CPU profile — self-time by research bucket (total self-time samples: 116336)

| bucket | self-time samples | share |
|---|---|---|
| entities/mobs (kernel) | 29050 | 25.0% |
| kernel: other | 27471 | 23.6% |
| other | 15200 | 13.1% |
| moonrise/paper patches | 9683 | 8.3% |
| chunk system (kernel) | 9272 | 8.0% |
| fastutil collections | 6995 | 6.0% |
| JDK collections | 6299 | 5.4% |
| JIT stubs (vtable/itable) | 3453 | 3.0% |
| network (kernel) | 3203 | 2.8% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 92411 | 79.4% |
| phase: unclassified | 13967 | 12.0% |
| phase: main tick (unclassified) | 3763 | 3.2% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **100411** (86.3%) · native/JVM-internal **15847** (13.6%) · other **78** (0.1%)

### CPU profile — top-40 leaf frames by self-time

| leaf frame | kind | samples | share |
|---|---|---|---|
| `net/minecraft/world/level/chunk/PalettedContainer.get` | JVM-Java | 4424 | 3.8% |
| `net/minecraft/world/entity/Entity.updateFluidHeightAndDoFluidPushing` | JVM-Java | 3590 | 3.1% |
| `vtable stub` | native/JVM-internal | 2915 | 2.5% |
...
| `net/minecraft/util/SimpleBitStorage.get` | JVM-Java | 1766 | 1.5% |
| `java/util/HashMap.getNode` | JVM-Java | 1725 | 1.5% |
| `net/minecraft/network/syncher/SynchedEntityData$DataItem.getValue` | JVM-Java | 1687 | 1.5% |
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1640 | 1.4% |
...
| `ca/spottedleaf/concurrentutil/map/ConcurrentLong2ReferenceChainedHashTable.getNode` | JVM-Java | 1425 | 1.2% |
| `net/minecraft/network/syncher/SynchedEntityData.getItem` | JVM-Java | 1407 | 1.2% |
| `it/unimi/dsi/fastutil/objects/Reference2ObjectOpenHashMap.get` | JVM-Java | 1311 | 1.1% |
...
| `net/minecraft/world/level/chunk/PalettedContainer.readPalette` | JVM-Java | 950 | 0.8% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/EntityLookup.getHardCollidingEntities` | JVM-Java | 741 | 0.6% |
...
| `java/util/ArrayList.isEmpty` | JVM-Java | 671 | 0.6% |
...
| `net/minecraft/world/entity/Entity.setTicksFrozen` | JVM-Java | 604 | 0.5% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52392** (85.5%) · native/JVM-internal **8862** (14.5%) · other **8** (0.0%)
...
|---|---|---|
| phase: entity tick (AI/movement) | 2070 | 55.8% |
| phase: unclassified | 1461 | 39.4% |
...
| `net.minecraft.world.phys.AABB_[i]` | other | 541 | 14.6% |
| `char[]_[k]` | other | 450 | 12.1% |
| `byte[]_[k]` | other | 202 | 5.4% |
| `net.minecraft.core.BlockPos$MutableBlockPos_[i]` | other | 137 | 3.7% |
| `net.minecraft.core.BlockPos_[i]` | other | 135 | 3.6% |
| `java.util.ArrayList_[i]` | other | 127 | 3.4% |
| `long[]_[i]` | other | 122 | 3.3% |
| `java.lang.Object[]_[i]` | other | 120 | 3.2% |
...
| `net.minecraft.world.level.pathfinder.WalkNodeEvaluator$$Lambda+0x00007f973fa00a68_[i]` | other | 32 | 0.9% |
...
- **F1 module/JNI self-time share:** 0 / 116336 = **0.00%** — §8 PASS (< 2%)
- **F3 per-class entity tick split (top-12 by stack presence):**

| entity class tick | presence samples | share of CPU |
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34866 | 29.97% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22584 | 19.41% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6207 | 5.34% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5098 | 4.38% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4402 | 3.78% |
| `net/minecraft/world/entity/vehicle/AbstractBoat.tick` | 1134 | 0.97% |
| `net/minecraft/world/entity/ai/Brain.tick` | 903 | 0.78% |
...
| `net.minecraft.world.phys.AABB_[i]` | 541 | 14.6% |
| `char[]_[k]` | 450 | 12.1% |
| `byte[]_[k]` | 202 | 5.4% |
| `net.minecraft.core.BlockPos$MutableBlockPos_[i]` | 137 | 3.7% |
| `net.minecraft.core.BlockPos_[i]` | 135 | 3.6% |
| `java.util.ArrayList_[i]` | 127 | 3.4% |
| `long[]_[i]` | 122 | 3.3% |
| `java.lang.Object[]_[i]` | 120 | 3.2% |
| `java.util.ArrayList$Itr_[i]` | 80 | 2.2% |
- **F2 alloc-churn rate:** ~0 MB/s over the 60s alloc window (total 0.0 GB allocated in window; ap alloc default interval)
- **F2 GC-churn estimate:** 120 pauses / total 20656 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148019..151213 (delta 3194, churn 2.1%), summons=0
  - top movers (max-min across polls): minecraft:item 99557->103182, minecraft:drowned 3439->4573, minecraft:zombie 3671->4644, minecraft:husk 4518->5189, minecraft:creeper 4553->5180, minecraft:spider 4208->4796, minecraft:skeleton 4421->4870, minecraft:chicken 3363->3392
...
- `cpu-collapsed.txt` (57219074 B)
- `wall-collapsed.txt` (3792824 B)
- `alloc-collapsed.txt` (2110622 B)
- `cpu-flamegraph.html` (303526 B)
- `server-stdout.log` (250403 B)
- `gc.log` (113586 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
