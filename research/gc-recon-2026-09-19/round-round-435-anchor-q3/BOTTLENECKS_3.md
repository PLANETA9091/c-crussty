...
- boot reached Done: **1** (boot time 15.124 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [20.0, 1.7, 2.0, 2.2, 2.5, 2.6]
- spark tick-monitor MSPT: avg **420.01ms** / min 356.95ms / max **560.61ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-23T21:53:11Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 6758998 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 356.95 | — | — | — | 560.61 | 420.01 |

- entity totals seen: [148974, 150098, 151453]
- top entity types (max seen): minecraft:item×103290, minecraft:creeper×5200, minecraft:husk×5192, minecraft:spider×4881, minecraft:skeleton×4844, minecraft:zombie×4715, minecraft:drowned×4580, minecraft:sheep×3518, minecraft:chicken×3411, minecraft:cow×3366, minecraft:pig×3249, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/fdd9IGhRqg
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **115** (Full GC: **8**)
- total pause: **21322.5 ms**, avg **185.41 ms**, max **2461.5 ms**
- heap high-water seen: **7653 MB** -> last-after: **3652 MB**
...
### CPU profile — self-time by research bucket (total self-time samples: 116827)

| bucket | self-time samples | share |
|---|---|---|
| entities/mobs (kernel) | 28847 | 24.7% |
| kernel: other | 28079 | 24.0% |
| other | 14576 | 12.5% |
| moonrise/paper patches | 9987 | 8.5% |
| chunk system (kernel) | 9631 | 8.2% |
| fastutil collections | 7163 | 6.1% |
| JDK collections | 6333 | 5.4% |
| JIT stubs (vtable/itable) | 3497 | 3.0% |
| network (kernel) | 3360 | 2.9% |
| JDK invokes/VarHandle | 2335 | 2.0% |
| JDK other | 1854 | 1.6% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 93441 | 80.0% |
| phase: unclassified | 13314 | 11.4% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **101492** (86.9%) · native/JVM-internal **15264** (13.1%) · other **71** (0.1%)

### CPU profile — top-40 leaf frames by self-time

| leaf frame | kind | samples | share |
|---|---|---|---|
| `net/minecraft/world/level/chunk/PalettedContainer.get` | JVM-Java | 4695 | 4.0% |
| `net/minecraft/world/entity/Entity.updateFluidHeightAndDoFluidPushing` | JVM-Java | 3441 | 2.9% |
| `vtable stub` | native/JVM-internal | 2877 | 2.5% |
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2555 | 2.2% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1852 | 1.6% |
...
| `net/minecraft/network/syncher/SynchedEntityData.getItem` | JVM-Java | 1417 | 1.2% |
...
| `it/unimi/dsi/fastutil/objects/Object2ObjectOpenHashMap.get` | JVM-Java | 1044 | 0.9% |
...
| `it/unimi/dsi/fastutil/objects/ObjectLinkedOpenHashSet$SetIterator.next` | JVM-Java | 982 | 0.8% |
| `net/minecraft/world/entity/Entity.setDeltaMovement` | JVM-Java | 965 | 0.8% |
...
| `it/unimi/dsi/fastutil/objects/Reference2ObjectOpenHashMap.get` | JVM-Java | 865 | 0.7% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52374** (85.5%) · native/JVM-internal **8877** (14.5%) · other **3** (0.0%)
...
### ALLOC profile — self-time by research bucket (total alloc bytes: 3634)
...
|---|---|---|
| phase: entity tick (AI/movement) | 2013 | 55.4% |
| phase: unclassified | 1453 | 40.0% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **0** (0.0%) · native/JVM-internal **0** (0.0%) · other **3634** (100.0%)

### ALLOC profile — top-20 leaf frames by alloc bytes

| leaf frame | kind | bytes | share |
|---|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | other | 570 | 15.7% |
...
| `net.minecraft.server.level.ServerChunkCache$$Lambda+0x00007f8b0183dc18_[i]` | other | 29 | 0.8% |
| `net.minecraft.server.level.ServerLevel$$Lambda+0x00007f8b019ee458_[i]` | other | 29 | 0.8% |

## Preregistered CI metrics (TASK-230 F1/F2/F3)

- **F1 module/JNI self-time share:** 0 / 116827 = **0.00%** — §8 PASS (< 2%)
- **F3 per-class entity tick split (top-12 by stack presence):**

| entity class tick | presence samples | share of CPU |
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34578 | 29.60% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22810 | 19.52% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6423 | 5.50% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5318 | 4.55% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4475 | 3.83% |
| `net/minecraft/world/entity/vehicle/AbstractBoat.tick` | 1210 | 1.04% |
...
|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | 570 | 15.7% |
...
- **F2 GC-churn estimate:** 115 pauses / total 21323 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148095..151453 (delta 3358, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99522->103290, minecraft:drowned 3458->4580, minecraft:zombie 3665->4715, minecraft:creeper 4512->5200, minecraft:husk 4532->5192, minecraft:spider 4248->4881, minecraft:skeleton 4334->4844, minecraft:chicken 3380->3411
...
- `cpu-collapsed.txt` (57090571 B)
- `wall-collapsed.txt` (3741439 B)
- `alloc-collapsed.txt` (2150986 B)
- `cpu-flamegraph.html` (289274 B)
- `server-stdout.log` (253101 B)
- `gc.log` (108384 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
