...
- boot reached Done: **1** (boot time 15.913 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [20.0, 1.6, 1.9, 2.1, 2.4, 2.6]
- spark tick-monitor MSPT: avg **425.03ms** / min 370.33ms / max **548.56ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-23T16:19:28Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 6997131 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 370.33 | — | — | — | 548.56 | 425.03 |

- entity totals seen: [149106, 150249, 151450]
- top entity types (max seen): minecraft:item×103363, minecraft:creeper×5188, minecraft:husk×5172, minecraft:spider×4869, minecraft:skeleton×4833, minecraft:zombie×4703, minecraft:drowned×4569, minecraft:sheep×3519, minecraft:chicken×3398, minecraft:cow×3361, minecraft:pig×3243, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/ankdpb9VSn
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **122** (Full GC: **9**)
- total pause: **21579.9 ms**, avg **176.88 ms**, max **2405.4 ms**
- heap high-water seen: **7604 MB** -> last-after: **5274 MB**
...
### CPU profile — self-time by research bucket (total self-time samples: 115878)

| bucket | self-time samples | share |
|---|---|---|
| entities/mobs (kernel) | 28521 | 24.6% |
| kernel: other | 27906 | 24.1% |
| other | 14967 | 12.9% |
| chunk system (kernel) | 9618 | 8.3% |
| moonrise/paper patches | 9576 | 8.3% |
| fastutil collections | 7400 | 6.4% |
| JDK collections | 6002 | 5.2% |
| JIT stubs (vtable/itable) | 3484 | 3.0% |
| network (kernel) | 2969 | 2.6% |
| JDK invokes/VarHandle | 2325 | 2.0% |
| JDK other | 2044 | 1.8% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 91906 | 79.3% |
| phase: unclassified | 13782 | 11.9% |
| phase: main tick (unclassified) | 3834 | 3.3% |
| phase: chunk tick | 1996 | 1.7% |
| phase: network sync (ServerEntity) | 1955 | 1.7% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **100096** (86.4%) · native/JVM-internal **15711** (13.6%) · other **71** (0.1%)

### CPU profile — top-40 leaf frames by self-time

| leaf frame | kind | samples | share |
|---|---|---|---|
| `net/minecraft/world/level/chunk/PalettedContainer.get` | JVM-Java | 4596 | 4.0% |
| `net/minecraft/world/entity/Entity.updateFluidHeightAndDoFluidPushing` | JVM-Java | 3223 | 2.8% |
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2948 | 2.5% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1561 | 1.3% |
| `net/minecraft/util/SimpleBitStorage.get` | JVM-Java | 1530 | 1.3% |
| `ca/spottedleaf/moonrise/patches/collisions/CollisionUtil.getCollisionsForBlocksOrWorldBorder` | JVM-Java | 1501 | 1.3% |
| `net/minecraft/util/Mth.floor` | JVM-Java | 1474 | 1.3% |
| `java/lang/invoke/VarHandleReferences$FieldInstanceReadOnly.getVolatile` | JVM-Java | 1472 | 1.3% |
...
| `net/minecraft/world/level/chunk/PalettedContainer.readPalette` | JVM-Java | 1047 | 0.9% |
...
| `net/minecraft/world/entity/BatchCollector.flushStep` | JVM-Java | 850 | 0.7% |
| `net/minecraft/world/phys/AABB.<init>` | JVM-Java | 847 | 0.7% |
...
| `java/util/ArrayList.isEmpty` | JVM-Java | 709 | 0.6% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52376** (85.5%) · native/JVM-internal **8873** (14.5%) · other **6** (0.0%)
...
### ALLOC profile — self-time by research bucket (total alloc bytes: 3679)
...
|---|---|---|
| phase: entity tick (AI/movement) | 2053 | 55.8% |
| phase: unclassified | 1446 | 39.3% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **0** (0.0%) · native/JVM-internal **0** (0.0%) · other **3679** (100.0%)
...
- **F1 module/JNI self-time share:** 0 / 115878 = **0.00%** — §8 PASS (< 2%)
- **F3 per-class entity tick split (top-12 by stack presence):**

| entity class tick | presence samples | share of CPU |
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34138 | 29.46% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22319 | 19.26% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6325 | 5.46% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5301 | 4.57% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4502 | 3.89% |
...
- **F2 GC-churn estimate:** 122 pauses / total 21580 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148226..151450 (delta 3224, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99730->103363, minecraft:zombie 3641->4703, minecraft:drowned 3524->4569, minecraft:husk 4509->5172, minecraft:creeper 4527->5188, minecraft:spider 4267->4869, minecraft:skeleton 4377->4833, minecraft:chicken 3369->3398
...
- `cpu-collapsed.txt` (58485286 B)
- `wall-collapsed.txt` (3534809 B)
- `alloc-collapsed.txt` (1998433 B)
- `cpu-flamegraph.html` (289208 B)
- `server-stdout.log` (261894 B)
- `gc.log` (115297 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
