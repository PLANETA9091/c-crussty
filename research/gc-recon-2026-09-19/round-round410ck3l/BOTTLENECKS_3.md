...
- boot reached Done: **1** (boot time 15.814 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [18.2, 1.6, 1.9, 2.1, 2.5, 2.5]
- spark tick-monitor MSPT: avg **423.42ms** / min 356.73ms / max **508.75ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-22T02:28:19Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 7135980 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 356.73 | — | — | — | 508.75 | 423.42 |

- entity totals seen: [149018, 150183, 151401]
- top entity types (max seen): minecraft:item×103215, minecraft:husk×5246, minecraft:creeper×5240, minecraft:skeleton×4868, minecraft:spider×4798, minecraft:zombie×4684, minecraft:drowned×4541, minecraft:sheep×3516, minecraft:chicken×3442, minecraft:cow×3362, minecraft:pig×3283, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/CdmyfzMJMR
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **117** (Full GC: **10**)
- total pause: **24038.0 ms**, avg **205.45 ms**, max **2668.5 ms**
- heap high-water seen: **7471 MB** -> last-after: **5550 MB**
...
|---|---|---|
| entities/mobs (kernel) | 28239 | 24.3% |
| kernel: other | 27484 | 23.6% |
| other | 15319 | 13.2% |
| moonrise/paper patches | 10390 | 8.9% |
| chunk system (kernel) | 9435 | 8.1% |
| fastutil collections | 7080 | 6.1% |
| JDK collections | 5950 | 5.1% |
| JIT stubs (vtable/itable) | 3497 | 3.0% |
| network (kernel) | 3096 | 2.7% |
| JDK invokes/VarHandle | 2752 | 2.4% |
| JDK other | 2075 | 1.8% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 92369 | 79.4% |
| phase: unclassified | 13872 | 11.9% |
| phase: main tick (unclassified) | 3816 | 3.3% |
| phase: chunk tick | 2057 | 1.8% |
| phase: network sync (ServerEntity) | 1781 | 1.5% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **100373** (86.2%) · native/JVM-internal **15916** (13.7%) · other **87** (0.1%)
...
| `net/minecraft/world/entity/Entity.updateFluidHeightAndDoFluidPushing` | JVM-Java | 3744 | 3.2% |
| `vtable stub` | native/JVM-internal | 2911 | 2.5% |
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2352 | 2.0% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1868 | 1.6% |
...
| `java/util/HashMap.getNode` | JVM-Java | 1472 | 1.3% |
| `net/minecraft/util/Mth.floor` | JVM-Java | 1458 | 1.3% |
| `net/minecraft/util/SimpleBitStorage.get` | JVM-Java | 1393 | 1.2% |
...
| `it/unimi/dsi/fastutil/objects/Reference2ObjectOpenHashMap.get` | JVM-Java | 1216 | 1.0% |
| `net/minecraft/world/level/chunk/PalettedContainer.readPalette` | JVM-Java | 1088 | 0.9% |
| `net/minecraft/server/level/ServerLevel.lambda$tick$4` | JVM-Java | 1059 | 0.9% |
| `net/minecraft/world/level/chunk/LevelChunk.getFluidState` | JVM-Java | 1048 | 0.9% |
| `net/minecraft/world/entity/Entity.setDeltaMovement` | JVM-Java | 1020 | 0.9% |
...
| `it/unimi/dsi/fastutil/objects/ObjectLinkedOpenHashSet$SetIterator.next` | JVM-Java | 877 | 0.8% |
...
| `net/minecraft/world/entity/Entity.applyEffectsFromBlocks` | JVM-Java | 795 | 0.7% |
...
| `java/util/ArrayList.isEmpty` | JVM-Java | 650 | 0.6% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **52403** (85.5%) · native/JVM-internal **8849** (14.4%) · other **5** (0.0%)
...
|---|---|---|
| phase: entity tick (AI/movement) | 2037 | 56.1% |
| phase: unclassified | 1415 | 38.9% |
...
|---|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | other | 548 | 15.1% |
| `net.minecraft.world.phys.AABB_[i]` | other | 517 | 14.2% |
...
| `net.minecraft.core.BlockPos_[i]` | other | 130 | 3.6% |
...
| `net.minecraft.world.level.chunk.LevelChunkSection[][]_[i]` | other | 53 | 1.5% |
...
| `net.minecraft.world.entity.Entity$$Lambda+0x00007f9bed9f6af0_[i]` | other | 35 | 1.0% |
...
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34607 | 29.74% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22549 | 19.38% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6380 | 5.48% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5317 | 4.57% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4463 | 3.83% |
| `net/minecraft/world/entity/vehicle/AbstractBoat.tick` | 1132 | 0.97% |
| `net/minecraft/world/entity/ai/Brain.tick` | 935 | 0.80% |
| `net/minecraft/world/entity/npc/Villager.tick` | 486 | 0.42% |
...
|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | 548 | 15.1% |
| `net.minecraft.world.phys.AABB_[i]` | 517 | 14.2% |
| `char[]_[k]` | 439 | 12.1% |
| `byte[]_[k]` | 195 | 5.4% |
| `long[]_[i]` | 149 | 4.1% |
| `net.minecraft.core.BlockPos$MutableBlockPos_[i]` | 146 | 4.0% |
| `net.minecraft.core.BlockPos_[i]` | 130 | 3.6% |
| `java.util.ArrayList_[i]` | 115 | 3.2% |
| `byte[]_[i]` | 102 | 2.8% |
| `java.lang.Object[]_[i]` | 88 | 2.4% |
- **F2 alloc-churn rate:** ~0 MB/s over the 60s alloc window (total 0.0 GB allocated in window; ap alloc default interval)
- **F2 GC-churn estimate:** 117 pauses / total 24038 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148094..151401 (delta 3307, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99484->103215, minecraft:drowned 3423->4541, minecraft:zombie 3658->4684, minecraft:husk 4540->5246, minecraft:creeper 4574->5240, minecraft:spider 4200->4798, minecraft:skeleton 4408->4868, minecraft:pig 3256->3283
...
- `cpu-collapsed.txt` (57860272 B)
- `wall-collapsed.txt` (3746130 B)
- `alloc-collapsed.txt` (2047453 B)
- `cpu-flamegraph.html` (301134 B)
- `server-stdout.log` (261786 B)
- `gc.log` (111899 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
