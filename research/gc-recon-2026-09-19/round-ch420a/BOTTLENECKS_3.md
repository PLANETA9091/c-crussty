...
- boot reached Done: **1** (boot time 15.562 s)
- forceload commands issued: 36 (9216 chunks force-loaded)
- TPS polls captured: 6, first-of-window values: [20.1, 1.6, 1.9, 2.1, 2.4, 2.5]
- spark tick-monitor MSPT: avg **429.23ms** / min 356.55ms / max **543.15ms** (>50ms = TPS<20)
### Run environment (pairing discipline, S7-96d)

- date_utc: 2026-09-22T22:12:58Z
- world_url: https://storage.shield.land/public.php/dav/files/twzsxN3HkBQtyED/Season%203/MineShield-3__Min--Normal.zip
- world_sha256: afb3a0b3ba78397b833032574ed2a1af8c4279dc7cfa31d9cffa0f217a6112d5
- runner_cpu_index: 6758845 (iters/s fixed 6M-step LCG loop; higher = faster/less contended runner)
- nproc: 4
- summon_sweeps: 0
...
|---|---|---|---|---|---|---|
| spark tickmonitor (whole run, [⚡] lines) | 356.55 | — | — | — | 543.15 | 429.23 |

- entity totals seen: [149087, 150234, 151405]
- top entity types (max seen): minecraft:item×103308, minecraft:creeper×5187, minecraft:husk×5178, minecraft:skeleton×4869, minecraft:spider×4793, minecraft:zombie×4643, minecraft:drowned×4548, minecraft:sheep×3522, minecraft:chicken×3412, minecraft:cow×3366, minecraft:pig×3220, minecraft:item_frame×2714
- spark viewer report: https://spark.lucko.me/v0PO5kBuqC
- tick-behind warnings in log: 0

### GC (from gc.log)

- pause events: **118** (Full GC: **9**)
- total pause: **21126.8 ms**, avg **179.04 ms**, max **2479.2 ms**
- heap high-water seen: **7660 MB** -> last-after: **4376 MB**
...
### CPU profile — self-time by research bucket (total self-time samples: 116276)

| bucket | self-time samples | share |
|---|---|---|
| entities/mobs (kernel) | 28489 | 24.5% |
| kernel: other | 27707 | 23.8% |
| other | 15112 | 13.0% |
| moonrise/paper patches | 9793 | 8.4% |
| chunk system (kernel) | 9727 | 8.4% |
| fastutil collections | 7271 | 6.3% |
| JDK collections | 5728 | 4.9% |
| JIT stubs (vtable/itable) | 3639 | 3.1% |
| network (kernel) | 3197 | 2.7% |
| JDK invokes/VarHandle | 2709 | 2.3% |
| JDK other | 1807 | 1.6% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 92574 | 79.6% |
| phase: unclassified | 13802 | 11.9% |
| phase: main tick (unclassified) | 3737 | 3.2% |
| phase: chunk tick | 2008 | 1.7% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **100444** (86.4%) · native/JVM-internal **15757** (13.6%) · other **75** (0.1%)

### CPU profile — top-40 leaf frames by self-time

| leaf frame | kind | samples | share |
|---|---|---|---|
| `net/minecraft/world/level/chunk/PalettedContainer.get` | JVM-Java | 4665 | 4.0% |
| `net/minecraft/world/entity/Entity.updateFluidHeightAndDoFluidPushing` | JVM-Java | 3340 | 2.9% |
| `vtable stub` | native/JVM-internal | 3066 | 2.6% |
| `net/minecraft/world/phys/AABB.intersects` | JVM-Java | 2685 | 2.3% |
...
| `ca/spottedleaf/moonrise/patches/chunk_system/level/entity/ChunkEntitySlices.getEntities` | JVM-Java | 1792 | 1.5% |
| `net/minecraft/network/syncher/SynchedEntityData$DataItem.getValue` | JVM-Java | 1660 | 1.4% |
...
| `ca/spottedleaf/moonrise/patches/collisions/CollisionUtil.getCollisionsForBlocksOrWorldBorder` | JVM-Java | 1487 | 1.3% |
...
| `net/minecraft/world/entity/InsideBlockOps.gate` | JVM-Java | 986 | 0.8% |
...
| `net/minecraft/world/entity/Entity.applyEffectsFromBlocks` | JVM-Java | 857 | 0.7% |
...
| `void OopOopIterateBoundedDispatch<PSPushContentsClosure>::Table::oop_oop_iterate_bounded<InstanceKlass, narrowOop>` | native/JVM-internal | 810 | 0.7% |
...
|---|---|---|
| other | 60310 | 94.7% |
| entities/mobs (kernel) | 971 | 1.5% |
| kernel: other | 899 | 1.4% |
...
| phase | self-time samples | share |
|---|---|---|
| phase: unclassified | 60111 | 94.4% |
| phase: entity tick (AI/movement) | 3131 | 4.9% |
...
**JVM-vs-native split (leaf self-time):** JVM-Java **54728** (86.0%) · native/JVM-internal **8924** (14.0%) · other **4** (0.0%)

### WALL profile — top-20 leaf frames by self-time

| leaf frame | kind | samples | share |
|---|---|---|---|
| `/usr/lib/x86_64-linux-gnu/libc.so.6` | JVM-Java | 51395 | 80.7% |
| `clock_nanosleep` | native/JVM-internal | 4771 | 7.5% |
...
|---|---|---|
| phase: entity tick (AI/movement) | 2010 | 55.0% |
...
|---|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | other | 559 | 15.3% |
| `net.minecraft.world.phys.AABB_[i]` | other | 506 | 13.8% |
| `char[]_[k]` | other | 438 | 12.0% |
| `byte[]_[k]` | other | 214 | 5.9% |
| `net.minecraft.core.BlockPos_[i]` | other | 182 | 5.0% |
...
| `net.minecraft.server.level.ServerChunkCache$$Lambda+0x00007f9cbd8301f8_[i]` | other | 29 | 0.8% |
| `int[]_[k]` | other | 28 | 0.8% |

## Preregistered CI metrics (TASK-230 F1/F2/F3)

- **F1 module/JNI self-time share:** 0 / 116276 = **0.00%** — §8 PASS (< 2%)
- **F3 per-class entity tick split (top-12 by stack presence):**

| entity class tick | presence samples | share of CPU |
|---|---|---|
| `net/minecraft/world/entity/item/ItemEntity.tick` | 34674 | 29.82% |
| `net/minecraft/world/entity/monster/Zombie.tick` | 22462 | 19.32% |
| `net/minecraft/world/entity/monster/Skeleton.tick` | 6400 | 5.50% |
| `net/minecraft/world/entity/monster/Spider.tick` | 5330 | 4.58% |
| `net/minecraft/world/entity/monster/Creeper.tick` | 4499 | 3.87% |
| `net/minecraft/world/entity/vehicle/AbstractBoat.tick` | 1146 | 0.99% |
...
|---|---|---|
| `net.minecraft.world.phys.Vec3_[i]` | 559 | 15.3% |
| `net.minecraft.world.phys.AABB_[i]` | 506 | 13.8% |
| `char[]_[k]` | 438 | 12.0% |
| `byte[]_[k]` | 214 | 5.9% |
| `net.minecraft.core.BlockPos_[i]` | 182 | 5.0% |
...
- **F2 GC-churn estimate:** 118 pauses / total 21127 ms STW (see GC section above; MB/s needs region-size constants — wired next tick)
- **F4 entity spawn/despawn churn (owner scenario):** polls=5 total=148146..151405 (delta 3259, churn 2.2%), summons=0
  - top movers (max-min across polls): minecraft:item 99702->103308, minecraft:drowned 3523->4548, minecraft:zombie 3704->4643, minecraft:creeper 4521->5187, minecraft:husk 4520->5178, minecraft:spider 4228->4793, minecraft:skeleton 4389->4869, minecraft:chicken 3384->3412
...
- `cpu-collapsed.txt` (56059278 B)
- `wall-collapsed.txt` (3738651 B)
- `alloc-collapsed.txt` (2024097 B)
- `cpu-flamegraph.html` (295392 B)
- `server-stdout.log` (258028 B)
- `gc.log` (111834 B)
- `ap.log` (72 B)
- `spark-report` (4096 B)
