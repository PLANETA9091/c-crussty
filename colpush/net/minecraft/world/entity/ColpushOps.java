...
public final class ColpushOps {
    ...
    private static final String FLAG10 = "cmp436_ins4"; // TASK-454-B: renumbered (FLAG5/6 taken by chunk union carrier)
    private static final String FLAG11 = "cmp451_senseins"; // TASK-454-B: senseins composite rides the carrier (STRICT-OR rebaze-2)
    ...
    private static boolean leverEnabled() {
        ...
        return f != null && (f.trim().equals(FLAG) || f.trim().equals(FLAG2) || f.trim().equals(FLAG3) || f.trim().equals(FLAG4) || f.trim().equals(FLAG5) || f.trim().equals(FLAG6) || f.trim().equals(FLAG7) || f.trim().equals(FLAG8) || f.trim().equals(FLAG9) || f.trim().equals(FLAG10) || f.trim().equals(FLAG11));
    }
