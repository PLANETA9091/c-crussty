 ...
 *  PaperNativeAquiferSurfaceSampling(I[J)I -> [newBatchSummary, oldBatchSummary]
...
public final class G2 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeAquiferSurfaceSampling"; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeAquiferSurfaceSampling.newBatchSummary(p0, p1); }
        case 1 -> { acc = PaperNativeAquiferSurfaceSampling.oldBatchSummary(p0, p1); }
        default -> acc = 0L;
        }
