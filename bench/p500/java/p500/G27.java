 ...
 *  PaperNativePalettedReencodeScratch(I[J)I -> [directPackedSummary, oldNewArraySummary, scratchThreadLocalSummary]
...
public final class G27 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativePalettedReencodeScratch"; }
    @Override public String sig() { return "(I[J)I"; }
    @Override public String[] methods() { return new String[]{"directPackedSummary", "oldNewArraySummary", "scratchThreadLocalSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativePalettedReencodeScratch.directPackedSummary(p0, p1); }
        case 1 -> { acc = PaperNativePalettedReencodeScratch.oldNewArraySummary(p0, p1); }
        case 2 -> { acc = PaperNativePalettedReencodeScratch.scratchThreadLocalSummary(p0, p1); }
        default -> acc = 0L;
        }
