 ...
 *  PaperNativeAquiferIndexStride(I[J)I -> [newBatchSummary, oldBatchSummary]
...
public final class G0 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeAquiferIndexStride"; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeAquiferIndexStride.newBatchSummary(p0, p1); }
        case 1 -> { acc = PaperNativeAquiferIndexStride.oldBatchSummary(p0, p1); }
        default -> acc = 0L;
        }
