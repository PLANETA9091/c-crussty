 ...
 *  PaperNativeDensityAp2Fill(II[J)I -> [oldFlatSummary, oldNestedSummary, scratchFlatSummary, scratchNestedSummary]
...
public final class G8 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeDensityAp2Fill"; }
    @Override public String sig() { return "(II[J)I"; }
    @Override public String[] methods() { return new String[]{"oldFlatSummary", "oldNestedSummary", "scratchFlatSummary", "scratchNestedSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeDensityAp2Fill.oldFlatSummary(p0, p1, p2); }
        case 1 -> { acc = PaperNativeDensityAp2Fill.oldNestedSummary(p0, p1, p2); }
        case 2 -> { acc = PaperNativeDensityAp2Fill.scratchFlatSummary(p0, p1, p2); }
        case 3 -> { acc = PaperNativeDensityAp2Fill.scratchNestedSummary(p0, p1, p2); }
        default -> acc = 0L;
        }
