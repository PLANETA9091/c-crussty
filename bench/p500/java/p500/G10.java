 ...
 *  PaperNativeDensitySplineContext(I[J)I -> [newDirectSummary, oldWrapperSummary]
...
public final class G10 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeDensitySplineContext"; }
    @Override public String sig() { return "(I[J)I"; }
    @Override public String[] methods() { return new String[]{"newDirectSummary", "oldWrapperSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeDensitySplineContext.newDirectSummary(p0, p1); }
        case 1 -> { acc = PaperNativeDensitySplineContext.oldWrapperSummary(p0, p1); }
        default -> acc = 0L;
        }
