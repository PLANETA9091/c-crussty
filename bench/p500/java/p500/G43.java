 ...
 *  PaperNativeSurfaceRulesTestRuleState(II[J)I -> [newStateRuleSummary, oldStateRuleSummary]
...
public final class G43 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeSurfaceRulesTestRuleState"; }
    @Override public String sig() { return "(II[J)I"; }
    @Override public String[] methods() { return new String[]{"newStateRuleSummary", "oldStateRuleSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeSurfaceRulesTestRuleState.newStateRuleSummary(p0, p1, p2); }
        case 1 -> { acc = PaperNativeSurfaceRulesTestRuleState.oldStateRuleSummary(p0, p1, p2); }
        default -> acc = 0L;
        }
