 ...
 *  PaperNativeXoroshiroPositionalDirect(I[I[I[IJJ[J)I -> [directDoubleBatchSummary, directFloatBatchSummary, oldDoubleBatchSummary, oldFloatBatchSummary]
...
public final class G48 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeXoroshiroPositionalDirect"; }
    @Override public String sig() { return "(I[I[I[IJJ[J)I"; }
    @Override public String[] methods() { return new String[]{"directDoubleBatchSummary", "directFloatBatchSummary", "oldDoubleBatchSummary", "oldFloatBatchSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeXoroshiroPositionalDirect.directDoubleBatchSummary(p0, p1, p2, p3, p4, p5, p6); }
        case 1 -> { acc = PaperNativeXoroshiroPositionalDirect.directFloatBatchSummary(p0, p1, p2, p3, p4, p5, p6); }
        case 2 -> { acc = PaperNativeXoroshiroPositionalDirect.oldDoubleBatchSummary(p0, p1, p2, p3, p4, p5, p6); }
        case 3 -> { acc = PaperNativeXoroshiroPositionalDirect.oldFloatBatchSummary(p0, p1, p2, p3, p4, p5, p6); }
        default -> acc = 0L;
        }
