 ...
 *  PaperNativeRemapperSkipHashes(ILjava/lang/String;[J)I -> [newLoopSummary, oldStreamSummary]
...
public final class G37 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeRemapperSkipHashes"; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeRemapperSkipHashes.newLoopSummary(p0, p1, p2); }
        case 1 -> { acc = PaperNativeRemapperSkipHashes.oldStreamSummary(p0, p1, p2); }
        default -> acc = 0L;
        }
