 ...
 *  PaperNativeMarkerCache(III[J)I -> [cachedSummary, oldSummary]
...
public final class G20 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeMarkerCache"; }
    @Override public String sig() { return "(III[J)I"; }
    @Override public String[] methods() { return new String[]{"cachedSummary", "oldSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeMarkerCache.cachedSummary(p0, p1, p2, p3); }
        case 1 -> { acc = PaperNativeMarkerCache.oldSummary(p0, p1, p2, p3); }
        default -> acc = 0L;
        }
