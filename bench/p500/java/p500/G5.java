 ...
 *  PaperNativeChunkDependencies(I[J)I -> [arraySummary, oldImmutableListSummary]
...
public final class G5 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeChunkDependencies"; }
    @Override public String sig() { return "(I[J)I"; }
    @Override public String[] methods() { return new String[]{"arraySummary", "oldImmutableListSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeChunkDependencies.arraySummary(p0, p1); }
        case 1 -> { acc = PaperNativeChunkDependencies.oldImmutableListSummary(p0, p1); }
        default -> acc = 0L;
        }
