...
/** P500 bench group 46 — generated. DO NOT EDIT.
 *  PaperNativeWaypointDistanceGuard(I[D[D[D[D[D[D[J)I -> [guardedReallyFarSummary, oldReallyFarSummary]
 *  Typed argument fields + direct static calls into the kernels:
 *  zero reflection in the hot loop, zero boxing of kernel results. */
public final class G46 implements p500.Group {
    ...
    @Override public String sig() { return "(I[D[D[D[D[D[D[J)I"; }
    @Override public String[] methods() { return new String[]{"guardedReallyFarSummary", "oldReallyFarSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeWaypointDistanceGuard.guardedReallyFarSummary(p0, p1, p2, p3, p4, p5, p6, p7); }
        case 1 -> { acc = PaperNativeWaypointDistanceGuard.oldReallyFarSummary(p0, p1, p2, p3, p4, p5, p6, p7); }
        default -> acc = 0L;
        }
