 ...
 *  PaperNativeOwnableRule(I[J)I -> [newLoopSummary, oldStreamSummary]
...
public final class G26 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeOwnableRule"; }
    @Override public String sig() { return "(I[J)I"; }
    @Override public String[] methods() { return new String[]{"newLoopSummary", "oldStreamSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeOwnableRule.newLoopSummary(p0, p1); }
        case 1 -> { acc = PaperNativeOwnableRule.oldStreamSummary(p0, p1); }
        default -> acc = 0L;
        }
