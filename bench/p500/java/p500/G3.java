...
/** P500 bench group 3 — generated. DO NOT EDIT.
 *  PaperNativeBlendedNoise(I[J)I -> [cachedBatchSummary, oldBatchSummary]
 *  Typed argument fields + direct static calls into the kernels:
 *  zero reflection in the hot loop, zero boxing of kernel results. */
public final class G3 implements p500.Group {
    private static final int[] SMALL = {7, 31, 3, 15, 63, 1, 9, 21};
    static int p0;
    static long[] p1;

    @Override public String fqcn() { return "PaperNativeBlendedNoise"; }
    @Override public String sig() { return "(I[J)I"; }
    @Override public String[] methods() { return new String[]{"cachedBatchSummary", "oldBatchSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeBlendedNoise.cachedBatchSummary(p0, p1); }
        case 1 -> { acc = PaperNativeBlendedNoise.oldBatchSummary(p0, p1); }
        default -> acc = 0L;
        }
