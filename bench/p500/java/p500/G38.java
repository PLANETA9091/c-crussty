 ...
 *  PaperNativeServerEntityDeltaIdentity(I[D[D[D[D[D[D[J)I -> [oldDistanceSummary]
...
public final class G38 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeServerEntityDeltaIdentity"; }
    @Override public String sig() { return "(I[D[D[D[D[D[D[J)I"; }
    @Override public String[] methods() { return new String[]{"oldDistanceSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeServerEntityDeltaIdentity.oldDistanceSummary(p0, p1, p2, p3, p4, p5, p6, p7); }
        default -> acc = 0L;
        }
