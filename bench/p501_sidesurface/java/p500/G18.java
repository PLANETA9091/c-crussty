 ...
 *  PaperNativeNearbyPlayerMap(II[J)I -> [defaultCapacitySummary, presizedCapacitySummary]
...
public final class G18 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeNearbyPlayerMap"; }
    @Override public String sig() { return "(II[J)I"; }
    @Override public String[] methods() { return new String[]{"defaultCapacitySummary", "presizedCapacitySummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeNearbyPlayerMap.defaultCapacitySummary(p0, p1, p2); }
        case 1 -> { acc = PaperNativeNearbyPlayerMap.presizedCapacitySummary(p0, p1, p2); }
        default -> acc = 0L;
        }
