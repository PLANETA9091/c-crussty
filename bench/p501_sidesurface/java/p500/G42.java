 ...
 *  net.minecraft.world.level.biome.PaperNativeClimateRTree(J[JI[I[J)I -> [nativeSearchBoundedBatchPacked]
...
public final class G42 implements p500.Group {
    ...
    @Override public String sig() { return "(J[JI[I[J)I"; }
    @Override public String[] methods() { return new String[]{"nativeSearchBoundedBatchPacked"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = net.minecraft.world.level.biome.PaperNativeClimateRTree.nativeSearchBoundedBatchPacked(p0, p1, p2, p3, p4); }
        default -> acc = 0L;
        }
