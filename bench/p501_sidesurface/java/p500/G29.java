 ...
 *  PaperNativeTicketPack([J[B[III[J)I -> [packSummary]
...
public final class G29 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeTicketPack"; }
    @Override public String sig() { return "([J[B[III[J)I"; }
    @Override public String[] methods() { return new String[]{"packSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeTicketPack.packSummary(p0, p1, p2, p3, p4, p5); }
        default -> acc = 0L;
        }
