 ...
 *  net.minecraft.world.level.levelgen.synth.PaperNativePerlinNoise(JDDD)D -> [nativeGetValueNoYScale]
...
public final class G46 implements p500.Group {
    ...
    @Override public String sig() { return "(JDDD)D"; }
    @Override public String[] methods() { return new String[]{"nativeGetValueNoYScale"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = Double.doubleToRawLongBits(net.minecraft.world.level.levelgen.synth.PaperNativePerlinNoise.nativeGetValueNoYScale(p0, p1, p2, p3)); }
        default -> acc = 0L;
        }
