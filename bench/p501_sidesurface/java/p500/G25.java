 ...
 *  PaperNativeRemapperHashThreshold(I[Ljava/lang/Object;[J)I -> [computeIfAbsentSummary, hybridSummary, parallelSummary, putSummary]
...
public final class G25 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeRemapperHashThreshold"; }
    @Override public String sig() { return "(I[Ljava/lang/Object;[J)I"; }
    @Override public String[] methods() { return new String[]{"computeIfAbsentSummary", "hybridSummary", "parallelSummary", "putSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeRemapperHashThreshold.computeIfAbsentSummary(p0, p1, p2); }
        case 1 -> { acc = PaperNativeRemapperHashThreshold.hybridSummary(p0, p1, p2); }
        case 2 -> { acc = PaperNativeRemapperHashThreshold.parallelSummary(p0, p1, p2); }
        case 3 -> { acc = PaperNativeRemapperHashThreshold.putSummary(p0, p1, p2); }
        default -> acc = 0L;
        }
