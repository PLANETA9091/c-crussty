 ...
 *  net.minecraft.world.level.levelgen.synth.PaperNativePerlinNoise(J)V -> [nativeFreeHandle]
...
public final class G45 implements p500.Group {
    ...
    @Override public String[] methods() { return new String[]{"nativeFreeHandle"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = 0L; net.minecraft.world.level.levelgen.synth.PaperNativePerlinNoise.nativeFreeHandle(p0); }
        default -> acc = 0L;
        }
