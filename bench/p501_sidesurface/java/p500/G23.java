 ...
 *  PaperNativePlacedFeatureTraversal(JI[J)I -> [recursiveSummary]
...
public final class G23 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativePlacedFeatureTraversal"; }
    @Override public String sig() { return "(JI[J)I"; }
    @Override public String[] methods() { return new String[]{"recursiveSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativePlacedFeatureTraversal.recursiveSummary(p0, p1, p2); }
        default -> acc = 0L;
        }
