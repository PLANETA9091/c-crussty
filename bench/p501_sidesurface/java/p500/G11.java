 ...
 *  PaperNativeHashPath([Ljava/lang/Object;[J)I -> [readAllSummary]
...
public final class G11 implements p500.Group {
    ...
    @Override public String sig() { return "([Ljava/lang/Object;[J)I"; }
    @Override public String[] methods() { return new String[]{"readAllSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeHashPath.readAllSummary(p0, p1); }
        default -> acc = 0L;
        }
