 ...
 *  PaperNativeChunkExpireCount(III[J)I -> [coldSummary]
...
public final class G4 implements p500.Group {
    ...
    @Override public String[] methods() { return new String[]{"coldSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeChunkExpireCount.coldSummary(p0, p1, p2, p3); }
        default -> acc = 0L;
        }
