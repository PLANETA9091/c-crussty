 ...
 *  PaperNativeNbtGzipBufferShape([IIII[J)I -> [shapeSummary]
...
public final class G17 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeNbtGzipBufferShape"; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeNbtGzipBufferShape.shapeSummary(p0, p1, p2, p3, p4); }
        default -> acc = 0L;
        }
