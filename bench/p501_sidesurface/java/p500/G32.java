 ...
 *  PaperNativeWaypointSnapshot(I[J)I -> [manualSummary, sizedArraySummary, toArraySummary]
...
public final class G32 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeWaypointSnapshot"; }
    @Override public String sig() { return "(I[J)I"; }
    @Override public String[] methods() { return new String[]{"manualSummary", "sizedArraySummary", "toArraySummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeWaypointSnapshot.manualSummary(p0, p1); }
        case 1 -> { acc = PaperNativeWaypointSnapshot.sizedArraySummary(p0, p1); }
        case 2 -> { acc = PaperNativeWaypointSnapshot.toArraySummary(p0, p1); }
        default -> acc = 0L;
        }
