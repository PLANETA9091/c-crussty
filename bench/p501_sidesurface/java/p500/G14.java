 ...
 *  PaperNativeLz4([B[B)I -> [lz4BlockDecompress]
...
public final class G14 implements p500.Group {
    ...
    @Override public String[] methods() { return new String[]{"lz4BlockDecompress"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeLz4.lz4BlockDecompress(p0, p1); }
        default -> acc = 0L;
        }
