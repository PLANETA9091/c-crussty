 ...
 *  PaperNativeYClampedGradient(I[I[I[I[D[D[J)I -> [currentBatchSummary, optimizedBatchSummary]
...
public final class G34 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeYClampedGradient"; }
    @Override public String sig() { return "(I[I[I[I[D[D[J)I"; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeYClampedGradient.currentBatchSummary(p0, p1, p2, p3, p4, p5, p6); }
        case 1 -> { acc = PaperNativeYClampedGradient.optimizedBatchSummary(p0, p1, p2, p3, p4, p5, p6); }
        default -> acc = 0L;
        }
