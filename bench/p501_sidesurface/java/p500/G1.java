 ...
 *  PaperNativeBiomeGetBiome(I[J[I[I[I[J)I -> [currentBatchSummary, optimizedBatchSummary]
...
public final class G1 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeBiomeGetBiome"; }
    @Override public String sig() { return "(I[J[I[I[I[J)I"; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeBiomeGetBiome.currentBatchSummary(p0, p1, p2, p3, p4, p5); }
        case 1 -> { acc = PaperNativeBiomeGetBiome.optimizedBatchSummary(p0, p1, p2, p3, p4, p5); }
        default -> acc = 0L;
        }
