 ...
 *  PaperNativeChunkExpireCount(IIII[J)I -> [hotSummary]
...
public final class G3 implements p500.Group {
    ...
    @Override public String fqcn() { return "PaperNativeChunkExpireCount"; }
    @Override public String sig() { return "(IIII[J)I"; }
    @Override public String[] methods() { return new String[]{"hotSummary"}; }
    ...
    @Override public long call(int idx) {
        long acc;
        switch (idx) {
        case 0 -> { acc = PaperNativeChunkExpireCount.hotSummary(p0, p1, p2, p3, p4); }
        default -> acc = 0L;
        }
