#!/usr/bin/env bash
# TASK-96 — Graal JIT LOADED A/B: C2 vs GraalVM CE 21 (-XX:+UseJVMCICompiler)
...
OUT="$PWD/bench/graal_ab/RAW_LOADED_$STAMP"; mkdir -p "$OUT"
...
echo "start-TASK96-graal-loaded-$STAMP" >> /home/z/BENCH.lock.journal
trap 'echo "done-TASK96-graal-loaded-$STAMP" >> /home/z/BENCH.lock.journal' EXIT
