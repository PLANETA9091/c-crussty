...
public final class BenchPopulationPlugin extends JavaPlugin {
    ...
    private static final int TOPUP_PER_TICK_MAX = 300;   // S7-148 cap; R468-S28: 100→300 — страховка дефицит-драйвена ≥330k (Л178/S66/S70/S68; budget=deficit/50, кап engages при deficit>15k)
