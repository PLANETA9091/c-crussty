...
case "${LEVER_FLAG:-}" in
  ...
  cmp456_chunkmono)
    ...
    ;; # TASK-466-C09: case-terminator repair (x466 P0-алерт C02: MERGE №9 line-union съел ';;' — canary-405 bench-step killer; база b79b516b несёт landmine, без ';;' bash -n FAIL и ЛЮБОЙ диспатч от этой базы горит 100%)
  cmp456_poi)
