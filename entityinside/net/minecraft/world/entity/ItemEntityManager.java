...
public final class ItemEntityManager {
    ...
    private static final boolean ENABLED =
            "items_subsys2".equals(LEVER_FLAG) || LEVER_FLAG.startsWith("cmp399_")
                    ...
                    || "cmp423_brain3".equals(LEVER_FLAG) || "cmp424_mobfeed".equals(LEVER_FLAG) || "cmp430_inside".equals(LEVER_FLAG) || "cmp432_inside2".equals(LEVER_FLAG) || "cmp436_ins4".equals(LEVER_FLAG) || "cmp451_senseins".equals(LEVER_FLAG) || LEVER_FLAG.equals("cmp457_paldelta") || LEVER_FLAG.equals("cmp457_paldelta_p31") || "cmp452_mega".equals(LEVER_FLAG) || "cmp434_chunkpl".equals(LEVER_FLAG) || "cmp435_chunk3".equals(LEVER_FLAG) || "cmp437_chunk4".equals(LEVER_FLAG) || "cmp444_chunk5".equals(LEVER_FLAG) || "cmp450_chunk".equals(LEVER_FLAG) || "cmp452_mega".equals(LEVER_FLAG) || "cmp453_diet".equals(LEVER_FLAG); // TASK-453-C diet composite (STRICT-OR)
