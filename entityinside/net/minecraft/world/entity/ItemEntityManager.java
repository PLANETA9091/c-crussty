...
public final class ItemEntityManager {
    ...
    private static final boolean DESPAWN2 =
            "cmp399_despawn2".equals(LEVER_FLAG) || "cmp399_bfcomp".equals(LEVER_FLAG)
                    ...
                    || "cmp424_mobfeed".equals(LEVER_FLAG) || "cmp430_inside".equals(LEVER_FLAG) || "cmp432_inside2".equals(LEVER_FLAG) || "cmp436_ins4".equals(LEVER_FLAG) || "cmp440_ins4d".equals(LEVER_FLAG); // TASK-442-B: ins4-диета STRICT OR
