...
public final class BrainOps {
    ...
    static final String TICK2_FLAGS = "cmp438_sense|cmp439_sense_scan|cmp451_senseins|cmp455_spawn"; // TASK-455-A: R4 despawn/spawn/activation scans carrier (STRICT-OR)
