#!/usr/bin/env python3
"""dispatch_457c.py — TASK-457-C leg dispatcher (R2 entity-query carrier).
...
concurrency guards). Creates refs round-457c-eqsnap2-{1,2} from
round-457c-eqsnap2 via git/refs API, then dispatches world-bench-parallel.yml.

Usage: python3 dispatch_457c.py <1|2|both> [--dry]
"""
import json
import re
import subprocess
...
BRANCH = "round-457c-eqsnap2"
EXPECTED_SHA = "9d71b461"  # union head (master 1838ae1d + cmp457_eqsnap2 union)
ANCESTRY_NOTE = "master 1838ae1d + union 9d71b461 (queryplane+eqsnap+cert stack)"
...
INPUTS = {
    ...
    "lever_flag": "cmp457_eqsnap2", "lever_arg": "1",
}
