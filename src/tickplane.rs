...
pub fn enabled() -> bool {
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            || v == "cmp420_colpush"
            || v == "cmp412_eqsnapv3" || v == "cmp414_cvs" || v == "cmp417_bq" || v == "cmp421_brain" || v == "cmp422_brain2" || v == "cmp423_brain3" || v == "cmp424_mobfeed" || v == "cmp428_chunkunion" || v == "cmp429_wgen" || v == "cmp434_wgen3"
        })
        .unwrap_or(false)
}
