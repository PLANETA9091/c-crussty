...
fn enabled() -> bool {
    matches!(
        ...
        Ok("cmp406_sscan") | Ok("cmp409_multi") | Ok("cmp412_meganav") | Ok("cmp414_cvs")
            ...
            | Ok("cmp451_senseins") | Ok("cmp458_swar") | Ok("cmp458_swar_papaya") | Ok("cmp457_paldelta") // TASK-452-A: senseins composite (carrier ins4 + sense/brain family, STRICT OR) — production gate retag for carrier-parity
