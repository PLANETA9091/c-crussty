...
fn enabled() -> bool {
 ...
 || | Ok("cmp423_brain3") | Ok("cmp424_mobfeed") | Ok("cmp430_inside") | Ok("cmp432_inside2") | Ok("cmp436_ins4") | Ok("cmp457_eqsnap2")            | Ok("cmp438_sense") // TASK-444-C: sense family union
            ...
            | Ok("cmp451_senseins") | Ok("cmp457_paldelta") // TASK-452-A: senseins composite (carrier ins4 + sense/brain family, STRICT OR) — production gate retag for carrier-parity
 || | Ok("cmp451_senseins") | Ok("cmp457_eqsnap2") // TASK-452-A: senseins composite (carrier ins4 + sense/brain family, STRICT OR) — production gate retag for carrier-parity
