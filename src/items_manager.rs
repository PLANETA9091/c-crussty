...
pub fn activate() {
    ...
    let comp = flag == "cmp402_comp"
        ...
        // TASK-419-A (colpush): колпаш-носитель (STRICT OR).
        || flag == "cmp420_colpush";
        || flag == "cmp421_brain" || flag == "cmp422_brain2" || flag == "cmp423_brain3" || flag == "cmp424_mobfeed" || flag == "cmp430_inside" || flag == "cmp434_chunkpl" || flag == "cmp435_chunk3" || flag == "cmp437_chunk4" || flag == "cmp444_chunk5" || flag == "cmp450_chunk" || flag == "cmp432_inside2";    let despawn2 = flag == "cmp399_despawn2" || bfcomp || comp;
    if shard {
