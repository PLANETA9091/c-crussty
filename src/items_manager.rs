...
fn lever_flag_matches_for(f: &str) -> bool {
    ...
    f == "items_subsys2" || f.starts_with("cmp399_") || f == "cmp402_comp"
        ...
        || f == "cmp409_multi" || f == "cmp412_meganav" || f == "cmp414_cvs" || f == "cmp414_pfb"
...
pub fn activate() {
    ...
    let comp = flag == "cmp402_comp"
        ...
        || flag == "cmp409_multi" || flag == "cmp412_meganav" || flag == "cmp414_cvs" || flag == "cmp414_pfb"
        // TASK-412-C (eqsnap-v3): meganav ⊕ eqsnap — STRICT OR.
        || flag == "cmp412_eqsnapv3" || flag == "cmp414_cvs" || flag == "cmp414_pfb";
