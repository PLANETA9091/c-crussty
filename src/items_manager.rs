...
fn lever_flag_matches_for(f: &str) -> bool {
    ...
    f == "items_subsys2" || f.starts_with("cmp399_") || f == "cmp402_comp"
        ...
        || f == "cmp420_colpush"
        || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp444_chunk5" || f == "cmp450_chunk" || f == "cmp432_inside2" || f == "cmp436_ins4"}
