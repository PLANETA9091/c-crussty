...
fn enabled() -> bool {
    matches!(
        ...
        Ok("cmp401_stagger") | Ok("cmp402_stagcomp") | Ok("cmp403_tickplane")
            ...
            | Ok("cmp451_senseins") | Ok("cmp457_paldelta") | Ok("cmp457_paldelta_p31") // TASK-452-A: senseins composite (carrier ins4 + sense/brain family, STRICT OR) — production gate retag for carrier-parity
