...
fn tick2_enabled() -> bool {
    ...
    matches!(
        ...
        Ok("cmp438_sense") | Ok("cmp439_sense_scan") | Ok("cmp451_senseins") | Ok("cmp457_paldelta") | Ok("cmp457_eqsnap2") // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
    )
}
