...
fn enabled() -> bool {
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            || v == "cmp451_senseins" || v == "cmp453_diet" || v == "cmp450_chunk" || v == "cmp457_noisesimd" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
            || v == "cmp453_diet" || v == "cmp450_chunk" || v == "cmp457_noisesimd" // TASK-453-C: diet composite (chunkparse-codec plane, STRICT OR — master ∪ {cmp453_diet} only)
            || v == "cmp451_senseins"|| v == "cmp434_chunkpl"|| v == "cmp435_chunk3"|| v == "cmp437_chunk4"|| v == "cmp444_chunk5"|| v == "cmp450_chunk" || v == "cmp457_noisesimd" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
        })
        .unwrap_or(false)
}
