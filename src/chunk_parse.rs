    ...
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            v == LEVER_ID || v == "cmp420_colpush"
                ...
                || v == "cmp420_colpush" || v == "cmp445_collide" || v == "cmp421_chunk" || v == "cmp421_brain" || v == "cmp422_brain2" || v == "cmp423_brain3" || v == "cmp424_mobfeed" || v == "cmp430_inside" || v == "cmp432_inside2" || v == "cmp436_ins4"
        })
        .unwrap_or(false)
}
