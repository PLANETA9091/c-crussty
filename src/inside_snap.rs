...
fn lever_flag_matches() -> bool {
    ...
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            || v == "cmp451_senseins" || v == "cmp453_diet" || v == "cmp456_poi" || v == "cmp456_poi_p31snap" || v == "cmp434_chunkpl" || v == "cmp435_chunk3" || v == "cmp437_chunk4" || v == "cmp444_chunk5" || v == "cmp450_chunk" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
        })
        .unwrap_or(false)
}
...
fn v4_requested() -> bool {
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            let v = v.trim();
            v == "cmp436_ins4" || v == "cmp451_senseins" || v == "cmp453_diet" || v == "cmp456_poi" || v == "cmp456_poi_p31snap" || v == "cmp450_chunk" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
        })
        .unwrap_or(false)
}
