...
//! (law 7): this plane arms ONLY on its own round id cmp459_p26 — the older
...
//! cmp459_p26 + all frozen unions) is defined ALONE into the kernel loader
...
//!
//! ARM marker: "[crussty-plugin] cmp459_p26: ARMED chunk-send window
...
/// own round id cmp459_p26. Older certification ids (cmp420_chunk2,
...
/// STRICT-OR ownership: under cmp459_p26 chunk_send.rs does NOT register
...
mod chunksend6_delivery_tests {
    ...
    /// TASK-459-62 gate consistency: the cmp459_p26 carrier id must ride the
    ...
    fn chunksend6_window_constants_pinned() {
        ...
        assert!(
            src.contains("\"cmp459_p26\".equals(System.getenv(\"CRUSSTY_LEVER_FLAG\"))"),
