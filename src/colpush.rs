...
/// TASK-445-A (cmp445_collide): bucket-таблица wide-phase prune (open-addressed,
...
struct BulkState {
    ...
    off_scratch: Vec<i32>,
    csr: Vec<i32>,
    // TASK-445-A (cmp445_collide): bucket-prune wide-phase arrays —
...
pub unsafe extern "system" fn colpush_tick(
    ...
    // TASK-445-A: единая точка bulk-JNI. Под cmp445_collide тело перечисления
