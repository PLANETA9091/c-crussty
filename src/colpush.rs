...
fn lever_flag_matches() -> bool {
    ...
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            || t == "cmp451_senseins" || t == "cmp458_swar" || t == "cmp457_paldelta" || t == "cmp457_eqsnap2" || t == "cmp456_chunkmono" || t == "cmp456_chunkmono_p31snap" || t == "cmp453_diet" || t == "cmp434_chunkpl" || t == "cmp435_chunk3" || t == "cmp437_chunk4" || t == "cmp444_chunk5" || t == "cmp450_chunk" || t == "cmp456_poi" || t == "cmp456_poi" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
