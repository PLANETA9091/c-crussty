...
fn lever_flag_matches() -> bool {
    ...
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            let t = v.trim();
            t == "cmp420_colpush" || t == "cmp424_mobfeed" || t == "cmp430_inside" || t == "cmp432_inside2" || t == "cmp436_ins4" || t == "cmp457_eqsnap2"
            || t == "cmp451_senseins" || t == "cmp457_eqsnap2" || t == "cmp453_diet" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
