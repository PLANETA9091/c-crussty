...
fn lever_flag_matches() -> bool {
    ...
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            || t == "cmp451_senseins" || t == "cmp452_mega" || t == "cmp453_diet" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
            || t == "cmp438_sense"
            || t == "cmp420_colpush" || t == "cmp452_mega" || t == "cmp424_mobfeed" || t == "cmp430_inside" || t == "cmp434_chunkpl" || t == "cmp435_chunk3" || t == "cmp437_chunk4" || t == "cmp444_chunk5" || t == "cmp450_chunk" || t == "cmp453_diet"
        })
        .unwrap_or(false)
}
