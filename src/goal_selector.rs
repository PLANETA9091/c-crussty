...
fn enabled() -> bool {
    match std::env::var("CRUSSTY_LEVER_FLAG") {
        Ok(v) => {
            ...
            || v == "cmp438_sense"
            || v == "cmp421_brain" || v == "cmp452_mega" || v == "cmp422_brain2" || v == "cmp423_brain3" || v == "cmp424_mobfeed" || v == "cmp430_inside" || v == "cmp434_chunkpl" || v == "cmp435_chunk3" || v == "cmp437_chunk4" || v == "cmp444_chunk5" || v == "cmp450_chunk"
        }
        Err(_) => false,
    }
}
