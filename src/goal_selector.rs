...
fn enabled() -> bool {
    match std::env::var("CRUSSTY_LEVER_FLAG") {
        Ok(v) => {
            let v = v.trim();
            v == "cmp421_brain" || v == "cmp422_brain2" || v == "cmp423_brain3" || v == "cmp424_mobfeed" || v == "cmp430_inside" || v == "cmp432_inside2" || v == "cmp436_ins4" || v == "cmp458_swar" || v == "cmp463_swar_hilbert" || v == "cmp457_paldelta" || v == "cmp457_eqsnap2" || v == "cmp456_chunkmono" || v == "cmp456_chunkmono_p31snap"
            ...
            || v == "cmp451_senseins" || v == "cmp458_swar" || v == "cmp463_swar_hilbert" || v == "cmp457_paldelta" || v == "cmp457_eqsnap2" || v == "cmp453_diet" || v == "cmp434_chunkpl" || v == "cmp435_chunk3" || v == "cmp437_chunk4" || v == "cmp444_chunk5" || v == "cmp450_chunk" || v == "cmp456_chunkmono" || v == "cmp456_chunkmono_p31snap" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
        }
        Err(_) => false,
    }
}
