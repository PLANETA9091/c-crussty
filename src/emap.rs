...
pub const RACE_FENCE_DEFAULT: bool = true; // re-armed after the TASK-413-A leg2 capture (95abe36, alias round-413-a-nofence pins the nofence sha) — branch tip must ship the validated race fence ARMED.
