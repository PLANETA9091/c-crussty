...
fn enabled() -> bool {
    ...
    matches!(
        ...
        Ok("cmp438_sense")
            ...
            | Ok("cmp424_mobfeed")
            | Ok("cmp430_inside")
            | Ok("cmp451_senseins") | Ok("cmp457_paldelta") | Ok("cmp457_paldelta_p31") // TASK-452-A: senseins composite (carrier ins4 + sense/brain family, STRICT OR) — PRODUCTION gate retag (x452: dormant -> SenseOps never defined, core of vector dead)
...
mod tests {
    ...
    fn enabled_with(s: &str) -> bool {
        s == "cmp438_sense" || s == "cmp439_sense_scan" || s == "cmp451_senseins" || s == "cmp457_paldelta" || s == "cmp457_paldelta_p31" || s == "cmp453_diet" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
    }
