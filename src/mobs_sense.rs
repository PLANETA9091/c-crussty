...
fn enabled() -> bool {
    ...
    matches!(
        ...
        Ok("cmp438_sense")
            ...
            | Ok("cmp453_diet") | Ok("cmp450_chunk") | Ok("cmp456_chunkmono") | Ok("cmp456_chunkmono_p31snap") | Ok("cmp466_c98ai") | Ok("cmp468_c98ai_m1") | Ok("cmp456_poi") // TASK-454-C: diet composite (STRICT OR, master planes + chunk delta)
)
}
