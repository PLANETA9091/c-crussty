...
/// STRICT-OR gate (law 7 round-id hygiene): the serialize-side plane arms ONLY
/// on its own round id cmp437_chunk4 — older certification ids (cmp420_chunk2,
/// cmp420_colpush, cmp421_*, cmp424_mobfeed, cmp430_inside, cmp434_chunkpl,
/// cmp435_chunk3) MUST NOT gain this plane (their certified semantics are
/// frozen). Empty/foreign flag = vanilla bit-in-bit.
fn enabled() -> bool {
