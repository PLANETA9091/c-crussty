...
fn enabled() -> bool {
    matches!(
        ...
        Ok("cmp456_poi") | Ok("cmp456_poi_wide") | Ok("cmp409_multi") | Ok("cmp412_meganav") | Ok("cmp412_eqsnapv3")
...
mod tests {
    ...
    fn enabled_with(s: &str) -> bool {
        s == "cmp456_poi" || s == "cmp456_poi_wide"
    }
