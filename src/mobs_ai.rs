...
fn enabled() -> bool {
    matches!(
        ...
        Ok("cmp406_aibatch") | Ok("cmp409_multi") | Ok("cmp412_meganav") | Ok("cmp414_cvs")
            ...
            | Ok("cmp453_diet") | Ok("cmp450_chunk") | Ok("cmp456_chunkmono") | Ok("cmp456_chunkmono_p31snap") | Ok("cmp466_c98ai") | Ok("cmp468_c98ai_m1") // TASK-454-C: diet composite (STRICT OR, master planes + chunk delta)
            | Ok("cmp421_brain")
            | Ok("cmp421_brain") | Ok("cmp434_chunkpl") | Ok("cmp435_chunk3") | Ok("cmp437_chunk4") | Ok("cmp444_chunk5") | Ok("cmp450_chunk") | Ok("cmp456_chunkmono") | Ok("cmp456_chunkmono_p31snap") | Ok("cmp466_c98ai") | Ok("cmp468_c98ai_m1") | Ok("cmp456_poi")
)
}
