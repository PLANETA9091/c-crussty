...
pub fn activate() {
    ...
    std::thread::spawn(move || {
        ...
        if f == GATE_LEVER_COMP || f == GATE_LEVER_STAGCOMP || f == GATE_LEVER_TICKPLANE || f == GATE_LEVER_STAGTICK || f == GATE_LEVER_AIBATCH || f == GATE_LEVER_SSCAN || f == GATE_LEVER_MULTI || f == "cmp412_meganav" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp432_inside2" || f == "cmp436_ins4" || f == "cmp440_ins4d" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp449_mega4" {
        ...
        } else if f == "cmp412_eqsnapv3" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp432_inside2" || f == "cmp436_ins4" || f == "cmp440_ins4d" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp449_mega4" {
            eprintln!(
        ...
        } else if f == "cmp420_colpush" || f == "cmp449_mega4" {
            eprintln!(
            ...
            if f == "cmp449_mega4" {
                ...
                // обязан содержать 'cmp449_mega4' + 'ARMED').
                eprintln!(
                    "[crussty-plugin] cmp449_mega4: ARMED carrier stack (cmp420-certified colpush ⊕ collide-batch ⊕ queryplane ⊕ eqsnap ⊕ chunk-parse ⊕ sscan/ai/items-плоскости; ДЕЛЬТА = colpushTick2 bucket-prune wide-phase: 16.0-бакеты + per-(row,bucket) reach-prune, CSR = оракул brute-force O(N^2), cargo test 4 suites; additивный STRICT-OR — прежние флаги несут прежние точные хвосты, пустой флаг = ваниль)"
                );
            }
        } else {
            eprintln!(
