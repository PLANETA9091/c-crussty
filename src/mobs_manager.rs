...
fn java_gate_matches(f: &str) -> bool {
    ...
    f == GATE_LEVER
        ...
        || f == "cmp451_senseins" || f == "cmp453_diet" || f == "cmp450_chunk" || f == "cmp456_chunkmono" || f == "cmp456_chunkmono_p31snap" || f == "cmp456_chunkmono_p31quant" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
        || f == "cmp438_sense" // TASK-444-C: sense family union
        || f == "cmp451_senseins" || f == "cmp453_diet" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp444_chunk5" || f == "cmp450_chunk" || f == "cmp456_chunkmono" || f == "cmp456_chunkmono_p31snap" || f == "cmp456_chunkmono_p31quant" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
        || f == GATE_LEVER_SSCAN
...
pub fn activate() {
    ...
    std::thread::spawn(move || {
        ...
        if f == GATE_LEVER_COMP || f == GATE_LEVER_STAGCOMP || f == GATE_LEVER_TICKPLANE || f == GATE_LEVER_STAGTICK || f == GATE_LEVER_AIBATCH || f == GATE_LEVER_SSCAN || f == GATE_LEVER_MULTI || f == "cmp412_meganav" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp432_inside2" || f == "cmp436_ins4" || f == "cmp451_senseins" || f == "cmp453_diet" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp444_chunk5" || f == "cmp450_chunk" || f == "cmp456_chunkmono" || f == "cmp456_chunkmono_p31snap" || f == "cmp456_chunkmono_p31quant" { // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
            eprintln!(
