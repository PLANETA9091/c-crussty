...
fn java_gate_matches(f: &str) -> bool {
    ...
    f == GATE_LEVER
        ...
        || f == "cmp420_colpush"
        || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp438_sense" || f == "cmp438_sense"
        || f == GATE_LEVER_SSCAN
...
pub fn activate() {
    ...
    std::thread::spawn(move || {
        ...
        if f == GATE_LEVER_COMP || f == GATE_LEVER_STAGCOMP || f == GATE_LEVER_TICKPLANE || f == GATE_LEVER_STAGTICK || f == GATE_LEVER_AIBATCH || f == GATE_LEVER_SSCAN || f == GATE_LEVER_MULTI || f == "cmp412_meganav" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp438_sense" || f == "cmp438_sense" {
            eprintln!(
        ...
        } else if f == "cmp412_eqsnapv3" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp438_sense" || f == "cmp438_sense" {
            eprintln!(
