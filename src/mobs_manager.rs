...
fn java_gate_matches(f: &str) -> bool {
    ...
    f == GATE_LEVER
        ...
        || f == "cmp420_colpush"
        || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp444_chunk5" || f == "cmp450_chunk"
        || f == GATE_LEVER_SSCAN
...
pub fn activate() {
    ...
    std::thread::spawn(move || {
        ...
        } else if f == "cmp412_eqsnapv3" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp434_chunkpl" || f == "cmp435_chunk3" || f == "cmp437_chunk4" || f == "cmp444_chunk5" || f == "cmp450_chunk" {
            eprintln!(
