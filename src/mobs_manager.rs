...
pub fn activate() {
    ...
    std::thread::spawn(move || {
        ...
        } else if f == "cmp412_eqsnapv3" || f == "cmp414_cvs" || f == "cmp417_bq" || f == "cmp421_brain" || f == "cmp422_brain2" || f == "cmp423_brain3" || f == "cmp424_mobfeed" || f == "cmp430_inside" || f == "cmp432_inside2" || f == "cmp436_ins4" || f == "cmp451_senseins" || f == "cmp453_diet" { // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
            eprintln!(
