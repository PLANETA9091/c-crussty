...
fn flag_enabled(flag: Option<&str>) -> bool {
    matches!(
        ...
        Some("cmp410_eindexq") | Some("cmp411_k4soa") | Some("cmp411_eqsnap")
            ...
            | Some("cmp456_chunkmono") | Some("cmp456_chunkmono_p31snap") | Some("cmp466_c98ai") | Some("cmp468_s18fluid")
    )
}
...
fn enabled_flag_is_sense() -> bool {
    matches!(
        ...
        Ok("cmp421_brain") | Ok("cmp422_brain2")
            ...
            | Ok("cmp453_diet") | Ok("cmp450_chunk") | Ok("cmp456_chunkmono") | Ok("cmp456_chunkmono_p31snap") | Ok("cmp456_chunkmono_p31snap") | Ok("cmp466_c98ai") | Ok("cmp468_s18fluid") | Ok("cmp456_poi") // TASK-454-C: diet composite (STRICT OR, master planes + chunk delta)
)
}
