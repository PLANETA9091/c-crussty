...
fn flag_enabled(flag: Option<&str>) -> bool {
    matches!(
        ...
        Some("cmp410_eindexq") | Some("cmp411_k4soa") | Some("cmp411_eqsnap")
            ...
            | Some("cmp423_brain3") | Some("cmp424_mobfeed") | Some("cmp430_inside") | Some("cmp432_inside2") | Some("cmp436_ins4") | Some("cmp457_paldelta") | Some("cmp457_paldelta_p31")
            | Some("cmp438_sense") // TASK-444-C: sense family union
            | Some("cmp451_senseins") | Some("cmp457_paldelta") | Some("cmp457_paldelta_p31") // TASK-452-A: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
...
fn enabled_flag_is_sense() -> bool {
    matches!(
        ...
        Ok("cmp421_brain") | Ok("cmp422_brain2")
            // TASK-424-A: GC-ревизия brain3 (STRICT OR).
            | Ok("cmp423_brain3") | Ok("cmp424_mobfeed") | Ok("cmp430_inside") | Ok("cmp432_inside2") | Ok("cmp436_ins4") | Ok("cmp457_paldelta") | Ok("cmp457_paldelta_p31")
            | Ok("cmp438_sense") // TASK-444-C: sense family union
            | Ok("cmp451_senseins") | Ok("cmp457_paldelta") | Ok("cmp457_paldelta_p31") // TASK-452-A: senseins composite — sense-arena slice must arm (production gate retag)
