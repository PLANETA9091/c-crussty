...
fn enabled() -> bool {
    matches!(
        ...
        Ok("cmp410_eindexq") | Ok("cmp411_k4soa") | Ok("cmp411_eqsnap")
            ...
            | Ok("cmp423_brain3") | Ok("cmp424_mobfeed") | Ok("cmp430_inside") | Ok("cmp428_chunkunion") | Ok("cmp429_wgen")
            | Ok("cmp421_brain")
    )
}
...
mod tests {
    ...
    fn enabled_with(s: &str) -> bool {
        s == "cmp410_eindexq"
            ...
            || s == "cmp421_brain" || s == "cmp422_brain2" || s == "cmp423_brain3" || s == "cmp424_mobfeed" || s == "cmp430_inside" || s == "cmp428_chunkunion" || s == "cmp429_wgen"
    }
