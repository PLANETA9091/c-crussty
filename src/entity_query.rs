...
fn enabled() -> bool {
    matches!(
        ...
        Ok("cmp410_eindexq") | Ok("cmp411_k4soa") | Ok("cmp411_eqsnap")
            ...
            | Ok("cmp412_eqsnapv3") | Ok("cmp414_cvs") | Ok("cmp414_pfb")
    )
}
...
fn enabled_flag_is_eqsnap() -> bool {
    matches!(
        std::env::var("CRUSSTY_LEVER_FLAG").as_deref(),
        Ok("cmp411_eqsnap") | Ok("cmp412_eqsnapv3") | Ok("cmp414_cvs") | Ok("cmp414_pfb")
    )
}
...
mod tests {
    ...
    fn enabled_with(s: &str) -> bool {
        s == "cmp410_eindexq"
            || s == "cmp411_k4soa"
            || s == "cmp411_eqsnap"
            || s == "cmp412_eqsnapv3" || s == "cmp414_cvs" || s == "cmp414_pfb"
    }
