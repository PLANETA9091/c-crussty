...
fn eqsnap_mode() -> bool {
    ...
    let f = FLAG
        ...
        .as_str();
    f == "cmp411_eqsnap" || f == "cmp412_eqsnapv3" || f == "cmp414_cvs" || f == "cmp416_gsel3" // TASK-416-B gsel-iter-3
        // TASK-416-B gsel-iter-3: живой cvs-носитель + gsel-слайс.
        || f == "cmp416_gsel3"
}
...
fn lever_mode() -> bool {
    ...
    f == "cmp401_soa"
        ...
        || f == "cmp412_meganav" || f == "cmp414_cvs" || f == "cmp416_gsel3" // TASK-416-B gsel-iter-3
