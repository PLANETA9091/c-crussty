    ...
    std::env::var("CRUSSTY_LEVER_FLAG")
        .map(|v| {
            ...
            v == "cmp401_collide" || v == "cmp403_tickplane" || v == "cmp405_stagtick"
                ...
                || v == "cmp451_senseins" || v == "cmp453_diet" || v == "cmp456_poi" || v == "cmp456_poi_p31snap" || v == "cmp450_chunk" // TASK-451-D: senseins composite (carrier ins4 + sense/brain family, STRICT OR)
