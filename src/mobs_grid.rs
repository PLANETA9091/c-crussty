        ...
        std::env::var("CRUSSTY_LEVER_FLAG")
            .map(|v| {
                v.trim() == "cmp402_comp"
                    ...
                    || v.trim() == "cmp421_brain" || v.trim() == "cmp452_mega" || v.trim() == "cmp422_brain2" || v == "cmp423_brain3" || v == "cmp424_mobfeed" || v == "cmp430_inside" || v == "cmp434_chunkpl" || v == "cmp435_chunk3" || v == "cmp437_chunk4" || v == "cmp444_chunk5" || v == "cmp450_chunk"
            })
            .unwrap_or(false)
    })
}
