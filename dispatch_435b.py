#!/usr/bin/env python3
"""dispatch_435b.py — ROUND-435 agent-B batch: inside2-DEEPEN round-4 SERVE-V3.
3 legs @round-435-b-ins5 (lever cmp435_inside3 STRICT-OR over cmp432_inside2)
+ 1 own anchor @master (pairing insurance; main tick's 7 anchors p3..v3 already
in flight). Big-interleaved, ONE window."""
...
BATCH = [
    ("b35v3-ins-1", "round-435b-ins-1", "round-435-b-ins5", "cmp435_inside3"),
    ("anchor-b35",  "round-435b-anchor-b35", "master", ""),
    ("b35v3-ins-2", "round-435b-ins-2", "round-435-b-ins5", "cmp435_inside3"),
    ("b35v3-ins-3", "round-435b-ins-3", "round-435-b-ins5", "cmp435_inside3"),
]
