...
> **СТАТУС 20 TPS (S7-106)**: СОЛО-ЭРА ЗАВЕРШЕНА, ПОДТВЕРЖДЕНА ТРИЖДЫ +
> ЛЕГАЛЬНАЯ ПАРА ПОСАЖЕНА — восемь STEP-0 киллов + min-of-2 профиль без
> заменимых соло >=3% + N-SCALING REFUTED + парная проверка (run#17 vs run#21,
> spread 1.3%, профиль стабилен). BENCH-4 база = **76.01ms на паре**
> (консервативная планка будущих A/B; кросс-класс: самый быстрый runner серии
> cpu_idx 10088241 даёт 57.01ms при N=16 — разрыв 76→57 = класс железа runner,
> не рандомный контеншн: внутри класса воспроизводимость 1.3%). ПУТИ ВПЕРЁД
> (все owner-gated): (2) семейные агрегаты <3% патчей (нужна санкция на
> пересмотр >=3% правила); (3) pinned/dedicated runner (устраняет классовую
> разницу; оценка эффекта железа ~25% MSPT); (4) смена сценария. МОДУЛЬНЫХ
> РЫЧАГОВ >=3% НЕТ; инфраструктура честных A/B (pair_hunter + band gate)
> самодостаточна — любой будущий рычаг получит легальный min-of-2.
