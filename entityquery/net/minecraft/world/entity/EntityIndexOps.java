...
public final class EntityIndexOps {
    ...
    private static boolean leverEnabled() {
        ...
        // TASK-461-66: cmp458_swar super-carrier union-widen (STRICT-OR, law
        // 4) — swarx-1 chain (push-plane) ⊕ roar (per-sec occupancy broadphase)
        // composite: BOTH arms on ONE flag, audit TASK-461-66 zero code-file
        // overlap => orthogonal sub-lanes.
        return "cmp405_eindex".equals(v) || "cmp458_roar".equals(v)
            || "cmp458_swar".equals(v);
    }
