...
public final class EntityGoalQueryOps {
    ...
    private static boolean leverEnabled() {
        ...
        return f != null && (f.trim().equals("cmp410_eindexq")
                ...
                || f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp430_inside") || f.trim().equals("cmp432_inside2") || f.trim().equals("cmp436_ins4") || f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp430_inside") || f.trim().equals("cmp434_chunkpl") || f.trim().equals("cmp435_chunk3") || f.trim().equals("cmp437_chunk4") || f.trim().equals("cmp444_chunk5") || f.trim().equals("cmp450_chunk") || f.trim().equals("cmp452_mega") || f.trim().equals("cmp453_diet") || f.trim().equals("cmp456_poi") || f.trim().equals("cmp456_poi_wide"));
    }
    ...
    private static boolean senseMode() {
        ...
        return f != null && (f.trim().equals("cmp421_brain")
                || f.trim().equals("cmp422_brain2")
                || f.trim().equals("cmp423_brain3")
                || f.trim().equals("cmp451_senseins") || f.trim().equals("cmp452_mega") || f.trim().equals("cmp453_diet") || f.trim().equals("cmp456_poi") || f.trim().equals("cmp456_poi_wide") || f.trim().equals("cmp450_chunk"));
    }
