...
public final class EntityGoalQueryOps {
    ...
    private static boolean leverEnabled() {
        ...
        return f != null && (f.trim().equals("cmp410_eindexq")
                ...
                || f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp430_inside") || f.trim().equals("cmp432_inside2") || f.trim().equals("cmp436_ins4") || f.trim().equals("cmp458_swar") || f.trim().equals("cmp457_paldelta") || f.trim().equals("cmp457_eqsnap2") || f.trim().equals("cmp424_mobfeed") || f.trim().equals("cmp430_inside") || f.trim().equals("cmp434_chunkpl") || f.trim().equals("cmp435_chunk3") || f.trim().equals("cmp437_chunk4") || f.trim().equals("cmp444_chunk5") || f.trim().equals("cmp450_chunk") || f.trim().equals("cmp456_chunkmono") || f.trim().equals("cmp456_chunkmono_p31snap") || f.trim().equals("cmp466_c98ai") || f.trim().equals("cmp468_c98ai_m1") || f.trim().equals("cmp452_mega") || f.trim().equals("cmp453_diet"));
    }
    ...
    private static boolean senseMode() {
        ...
        return f != null && (f.trim().equals("cmp421_brain")
                || f.trim().equals("cmp422_brain2")
                || f.trim().equals("cmp423_brain3")
                || f.trim().equals("cmp451_senseins") || f.trim().equals("cmp458_swar") || f.trim().equals("cmp457_paldelta") || f.trim().equals("cmp457_eqsnap2") || f.trim().equals("cmp452_mega") || f.trim().equals("cmp453_diet") || f.trim().equals("cmp450_chunk") || f.trim().equals("cmp456_chunkmono") || f.trim().equals("cmp456_chunkmono_p31snap") || f.trim().equals("cmp466_c98ai") || f.trim().equals("cmp468_c98ai_m1"));
    }
    ...
    static {
        ...
        FLAG_LABEL = t.equals("cmp422_brain2") ? "cmp422_brain2"
                ...
                : t.equals("cmp450_chunk") || t.equals("cmp456_chunkmono") || t.equals("cmp456_chunkmono_p31snap") || t.equals("cmp466_c98ai") || t.equals("cmp468_c98ai_m1") ? "cmp450_chunk" // TASK-450-C: union carrier marker id (chunk4+chunk5+slices)
                : t.equals("cmp452_mega") ? "cmp452_mega" // TASK-452-C mega-composite marker id
                : t.equals("cmp453_diet") || f.trim().equals("cmp450_chunk") || f.trim().equals("cmp456_chunkmono") || f.trim().equals("cmp456_chunkmono_p31snap") || f.trim().equals("cmp466_c98ai") || f.trim().equals("cmp468_c98ai_m1") ? "cmp453_diet" // TASK-453-C diet composite marker id
