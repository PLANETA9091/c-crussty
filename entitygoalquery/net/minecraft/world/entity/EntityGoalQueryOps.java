...
public final class EntityGoalQueryOps {
    ...
    private static boolean leverEnabled() {
        ...
        return f != null && (f.trim().equals("cmp410_eindexq")
                ...
                // TASK-419-B (sense-plane composite): STRICT OR — полный
                // композит master ⊕ sense-arena (см. senseArena/snapshotQuery).
    ...
    private static boolean senseMode() {
        String f = System.getenv("CRUSSTY_LEVER_FLAG");
        return f != null && f.trim().equals("cmp419_sense");
    }
    ...
    static {
        ...
        FLAG_LABEL = f != null && f.trim().equals("cmp419_sense")
                ? "cmp419_sense"
